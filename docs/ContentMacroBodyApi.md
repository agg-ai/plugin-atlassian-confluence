...
<a id="getAndAsyncConvertMacroBodyByMacroId"></a>
...
import io.kestra.plugin.atlassian_confluence.client.api.ContentMacroBodyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ContentMacroBodyApi apiInstance = new ContentMacroBodyApi(defaultClient);
    ...
    String to = "export_view"; // String | The content representation to return the macro in. Currently, the following conversions are allowed:  - `export_view` - `styled_view` - `view`
...
<a id="getAndConvertMacroBodyByMacroId"></a>
