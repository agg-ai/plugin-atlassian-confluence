...
import io.kestra.plugin.atlassian_confluence.client.api.ContentWatchesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ContentWatchesApi apiInstance = new ContentWatchesApi(defaultClient);
...
| **start** | **Integer**| The starting index of the returned watches. | [optional] [default to 0] |
| **limit** | **Integer**| The maximum number of watches to return per page. Note, this may be restricted by fixed system limits. | [optional] [default to 200] |
