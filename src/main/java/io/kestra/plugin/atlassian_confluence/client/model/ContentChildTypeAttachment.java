...
public class ContentChildTypeAttachment {
  ...
  public ContentChildTypeAttachment value(@javax.annotation.Nonnull Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public ContentChildTypeAttachment links(@javax.annotation.Nonnull Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("value", "_links"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("value", "_links"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentChildTypeAttachment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentChildTypeAttachment is not found in the empty JSON string", ContentChildTypeAttachment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentChildTypeAttachment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentChildTypeAttachment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
