...
public class SearchResult {
  ...
  public SearchResult content(@javax.annotation.Nullable Content content) {
  ...
  public void setContent(@javax.annotation.Nullable Content content) {
    this.content = content;
  }


  public SearchResult user(@javax.annotation.Nullable User user) {
    this.user = user;
    return this;
  }
  ...
  public SearchResult space(@javax.annotation.Nullable Space space) {
    this.space = space;
    return this;
  }
  ...
  public SearchResult title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public SearchResult excerpt(@javax.annotation.Nonnull String excerpt) {
  ...
  public void setExcerpt(@javax.annotation.Nonnull String excerpt) {
    this.excerpt = excerpt;
  }


  public SearchResult url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public SearchResult resultParentContainer(@javax.annotation.Nullable ContainerSummary resultParentContainer) {
  ...
  public void setResultParentContainer(@javax.annotation.Nullable ContainerSummary resultParentContainer) {
    this.resultParentContainer = resultParentContainer;
  }


  public SearchResult resultGlobalContainer(@javax.annotation.Nullable ContainerSummary resultGlobalContainer) {
  ...
  public void setResultGlobalContainer(@javax.annotation.Nullable ContainerSummary resultGlobalContainer) {
    this.resultGlobalContainer = resultGlobalContainer;
  }


  public SearchResult breadcrumbs(@javax.annotation.Nonnull List<Breadcrumb> breadcrumbs) {
  ...
  public void setBreadcrumbs(@javax.annotation.Nonnull List<Breadcrumb> breadcrumbs) {
    this.breadcrumbs = breadcrumbs;
  }


  public SearchResult entityType(@javax.annotation.Nonnull String entityType) {
  ...
  public SearchResult iconCssClass(@javax.annotation.Nonnull String iconCssClass) {
  ...
  public void setIconCssClass(@javax.annotation.Nonnull String iconCssClass) {
    this.iconCssClass = iconCssClass;
  }


  public SearchResult lastModified(@javax.annotation.Nonnull OffsetDateTime lastModified) {
  ...
  public SearchResult friendlyLastModified(@javax.annotation.Nullable String friendlyLastModified) {
  ...
  public void setFriendlyLastModified(@javax.annotation.Nullable String friendlyLastModified) {
    this.friendlyLastModified = friendlyLastModified;
  }


  public SearchResult score(@javax.annotation.Nullable BigDecimal score) {
    this.score = score;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("content", "user", "space", "title", "excerpt", "url", "resultParentContainer", "resultGlobalContainer", "breadcrumbs", "entityType", "iconCssClass", "lastModified", "friendlyLastModified", "score"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("title", "excerpt", "url", "breadcrumbs", "entityType", "iconCssClass", "lastModified"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SearchResult is not found in the empty JSON string", SearchResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SearchResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("excerpt").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `excerpt` to be a primitive type in the JSON string but got `%s`", jsonObj.get("excerpt").toString()));
      }
      ...
      if (!jsonObj.get("breadcrumbs").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `breadcrumbs` to be an array in the JSON string but got `%s`", jsonObj.get("breadcrumbs").toString()));
      }
      ...
      if (!jsonObj.get("iconCssClass").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `iconCssClass` to be a primitive type in the JSON string but got `%s`", jsonObj.get("iconCssClass").toString()));
      }
      if ((jsonObj.get("friendlyLastModified") != null && !jsonObj.get("friendlyLastModified").isJsonNull()) && !jsonObj.get("friendlyLastModified").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `friendlyLastModified` to be a primitive type in the JSON string but got `%s`", jsonObj.get("friendlyLastModified").toString()));
      }
  }
