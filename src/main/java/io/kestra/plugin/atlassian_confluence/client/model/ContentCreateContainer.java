...
import io.kestra.plugin.atlassian_confluence.client.model.ContentCreateContainerId;
...
public class ContentCreateContainer {
  ...
  public ContentCreateContainer id(@javax.annotation.Nonnull ContentCreateContainerId id) {
    this.id = id;
    return this;
  }
  ...
  public void setId(@javax.annotation.Nonnull ContentCreateContainerId id) {
    this.id = id;
  }


  public ContentCreateContainer type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentCreateContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentCreateContainer is not found in the empty JSON string", ContentCreateContainer.openapiRequiredFields.toString()));
        }
      }
