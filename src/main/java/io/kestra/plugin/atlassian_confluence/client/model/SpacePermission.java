...
import io.kestra.plugin.atlassian_confluence.client.model.SpacePermissionSubjects;
...
public class SpacePermission {
  ...
  public SpacePermission id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public SpacePermission subjects(@javax.annotation.Nullable SpacePermissionSubjects subjects) {
  ...
  public void setSubjects(@javax.annotation.Nullable SpacePermissionSubjects subjects) {
    this.subjects = subjects;
  }


  public SpacePermission operation(@javax.annotation.Nonnull OperationCheckResult operation) {
  ...
  public SpacePermission anonymousAccess(@javax.annotation.Nonnull Boolean anonymousAccess) {
  ...
  public SpacePermission unlicensedAccess(@javax.annotation.Nonnull Boolean unlicensedAccess) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "subjects", "operation", "anonymousAccess", "unlicensedAccess"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SpacePermission.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SpacePermission is not found in the empty JSON string", SpacePermission.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SpacePermission.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SpacePermission` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
