...
public class AsyncContentBodyExpandable {
  ...
  public AsyncContentBodyExpandable content(@javax.annotation.Nullable String content) {
  ...
  public AsyncContentBodyExpandable embeddedContent(@javax.annotation.Nullable String embeddedContent) {
  ...
  public void setEmbeddedContent(@javax.annotation.Nullable String embeddedContent) {
    this.embeddedContent = embeddedContent;
  }


  public AsyncContentBodyExpandable webresource(@javax.annotation.Nullable String webresource) {
  ...
  public void setWebresource(@javax.annotation.Nullable String webresource) {
    this.webresource = webresource;
  }


  public AsyncContentBodyExpandable mediaToken(@javax.annotation.Nullable String mediaToken) {
  ...
  public void setMediaToken(@javax.annotation.Nullable String mediaToken) {
    this.mediaToken = mediaToken;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("content", "embeddedContent", "webresource", "mediaToken"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AsyncContentBodyExpandable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AsyncContentBodyExpandable is not found in the empty JSON string", AsyncContentBodyExpandable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AsyncContentBodyExpandable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AsyncContentBodyExpandable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("embeddedContent") != null && !jsonObj.get("embeddedContent").isJsonNull()) && !jsonObj.get("embeddedContent").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `embeddedContent` to be a primitive type in the JSON string but got `%s`", jsonObj.get("embeddedContent").toString()));
      }
      if ((jsonObj.get("webresource") != null && !jsonObj.get("webresource").isJsonNull()) && !jsonObj.get("webresource").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `webresource` to be a primitive type in the JSON string but got `%s`", jsonObj.get("webresource").toString()));
      }
      if ((jsonObj.get("mediaToken") != null && !jsonObj.get("mediaToken").isJsonNull()) && !jsonObj.get("mediaToken").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `mediaToken` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mediaToken").toString()));
      }
  }
