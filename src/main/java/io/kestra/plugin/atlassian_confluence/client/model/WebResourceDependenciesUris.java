...
import io.kestra.plugin.atlassian_confluence.client.model.WebResourceDependenciesUrisExpandable;
...
public class WebResourceDependenciesUris {
  ...
  public WebResourceDependenciesUris all(@javax.annotation.Nullable SuperBatchWebResourcesUrisAll all) {
    this.all = all;
    return this;
  }
  ...
  public void setAll(@javax.annotation.Nullable SuperBatchWebResourcesUrisAll all) {
    this.all = all;
  }


  public WebResourceDependenciesUris css(@javax.annotation.Nullable SuperBatchWebResourcesUrisAll css) {
    this.css = css;
    return this;
  }
  ...
  public WebResourceDependenciesUris js(@javax.annotation.Nullable SuperBatchWebResourcesUrisAll js) {
    this.js = js;
    return this;
  }
  ...
  public WebResourceDependenciesUris expandable(@javax.annotation.Nullable WebResourceDependenciesUrisExpandable expandable) {
  ...
  public void setExpandable(@javax.annotation.Nullable WebResourceDependenciesUrisExpandable expandable) {
    this.expandable = expandable;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("all", "css", "js", "_expandable"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebResourceDependenciesUris.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WebResourceDependenciesUris is not found in the empty JSON string", WebResourceDependenciesUris.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebResourceDependenciesUris.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebResourceDependenciesUris` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
