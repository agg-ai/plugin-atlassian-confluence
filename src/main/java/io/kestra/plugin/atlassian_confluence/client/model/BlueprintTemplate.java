...
import io.kestra.plugin.atlassian_confluence.client.model.BlueprintTemplateOriginalTemplate;
...
public class BlueprintTemplate {
  ...
  public BlueprintTemplate templateId(@javax.annotation.Nonnull String templateId) {
  ...
  public BlueprintTemplate originalTemplate(@javax.annotation.Nonnull BlueprintTemplateOriginalTemplate originalTemplate) {
  ...
  public void setOriginalTemplate(@javax.annotation.Nonnull BlueprintTemplateOriginalTemplate originalTemplate) {
    this.originalTemplate = originalTemplate;
  }


  public BlueprintTemplate referencingBlueprint(@javax.annotation.Nonnull String referencingBlueprint) {
  ...
  public void setReferencingBlueprint(@javax.annotation.Nonnull String referencingBlueprint) {
    this.referencingBlueprint = referencingBlueprint;
  }


  public BlueprintTemplate name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public BlueprintTemplate description(@javax.annotation.Nonnull String description) {
  ...
  public BlueprintTemplate space(@javax.annotation.Nullable Map<String, Object> space) {
    this.space = space;
    return this;
  }
  ...
  public void setSpace(@javax.annotation.Nullable Map<String, Object> space) {
    this.space = space;
  }


  public BlueprintTemplate labels(@javax.annotation.Nonnull List<Label> labels) {
    this.labels = labels;
    return this;
  }
  ...
  public BlueprintTemplate templateType(@javax.annotation.Nonnull String templateType) {
  ...
  public BlueprintTemplate editorVersion(@javax.annotation.Nullable String editorVersion) {
  ...
  public void setEditorVersion(@javax.annotation.Nullable String editorVersion) {
    this.editorVersion = editorVersion;
  }


  public BlueprintTemplate body(@javax.annotation.Nullable ContentTemplateBody body) {
    this.body = body;
    return this;
  }
  ...
  public void setBody(@javax.annotation.Nullable ContentTemplateBody body) {
    this.body = body;
  }


  public BlueprintTemplate expandable(@javax.annotation.Nullable BlueprintTemplateExpandable expandable) {
  ...
  public void setExpandable(@javax.annotation.Nullable BlueprintTemplateExpandable expandable) {
    this.expandable = expandable;
  }


  public BlueprintTemplate links(@javax.annotation.Nonnull Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("templateId", "originalTemplate", "referencingBlueprint", "name", "description", "space", "labels", "templateType", "editorVersion", "body", "_expandable", "_links"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("templateId", "originalTemplate", "referencingBlueprint", "name", "description", "labels", "templateType", "_links"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BlueprintTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in BlueprintTemplate is not found in the empty JSON string", BlueprintTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BlueprintTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BlueprintTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("referencingBlueprint").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `referencingBlueprint` to be a primitive type in the JSON string but got `%s`", jsonObj.get("referencingBlueprint").toString()));
      }
      ...
      if ((jsonObj.get("editorVersion") != null && !jsonObj.get("editorVersion").isJsonNull()) && !jsonObj.get("editorVersion").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `editorVersion` to be a primitive type in the JSON string but got `%s`", jsonObj.get("editorVersion").toString()));
      }
