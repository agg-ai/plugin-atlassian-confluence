...
import io.kestra.plugin.atlassian_confluence.client.model.ContentRestrictionUpdateRestrictions;
...
public class ContentRestrictionUpdate {
  ...
  public ContentRestrictionUpdate operation(@javax.annotation.Nonnull OperationEnum operation) {
  ...
  public ContentRestrictionUpdate restrictions(@javax.annotation.Nonnull ContentRestrictionUpdateRestrictions restrictions) {
  ...
  public void setRestrictions(@javax.annotation.Nonnull ContentRestrictionUpdateRestrictions restrictions) {
    this.restrictions = restrictions;
  }


  public ContentRestrictionUpdate content(@javax.annotation.Nullable Content content) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("operation", "restrictions", "content"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("operation", "restrictions"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentRestrictionUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentRestrictionUpdate is not found in the empty JSON string", ContentRestrictionUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentRestrictionUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentRestrictionUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
