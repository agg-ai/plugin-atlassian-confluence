...
public class SuperBatchWebResourcesUrisAll extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SuperBatchWebResourcesUrisAll.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SuperBatchWebResourcesUrisAll.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SuperBatchWebResourcesUrisAll' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SuperBatchWebResourcesUrisAll>() {
                @Override
                public void write(JsonWriter out, SuperBatchWebResourcesUrisAll value) throws IOException {
                ...
                @Override
                public SuperBatchWebResourcesUrisAll read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        SuperBatchWebResourcesUrisAll ret = new SuperBatchWebResourcesUrisAll();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(Locale.ROOT, "Failed deserialization for SuperBatchWebResourcesUrisAll: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SuperBatchWebResourcesUrisAll(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return SuperBatchWebResourcesUrisAll.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to SuperBatchWebResourcesUrisAll
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(Locale.ROOT, "The JSON string is invalid for SuperBatchWebResourcesUrisAll with oneOf schemas: List<String>, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of SuperBatchWebResourcesUrisAll given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of SuperBatchWebResourcesUrisAll
     * @throws IOException if the JSON string is invalid with respect to SuperBatchWebResourcesUrisAll
     */
    public static SuperBatchWebResourcesUrisAll fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, SuperBatchWebResourcesUrisAll.class);
    }

    /**
     * Convert an instance of SuperBatchWebResourcesUrisAll to an JSON string
     *
     * @return JSON string
     */
