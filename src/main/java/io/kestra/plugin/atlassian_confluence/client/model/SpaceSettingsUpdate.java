...
public class SpaceSettingsUpdate {
  ...
  public SpaceSettingsUpdate routeOverrideEnabled(@javax.annotation.Nullable Boolean routeOverrideEnabled) {
  ...
  public void setRouteOverrideEnabled(@javax.annotation.Nullable Boolean routeOverrideEnabled) {
    this.routeOverrideEnabled = routeOverrideEnabled;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("routeOverrideEnabled"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SpaceSettingsUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SpaceSettingsUpdate is not found in the empty JSON string", SpaceSettingsUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SpaceSettingsUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SpaceSettingsUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
