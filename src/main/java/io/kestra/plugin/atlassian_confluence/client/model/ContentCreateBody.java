...
public class ContentCreateBody {
  ...
  public ContentCreateBody view(@javax.annotation.Nullable ContentBodyCreate view) {
    this.view = view;
    return this;
  }
  ...
  public ContentCreateBody exportView(@javax.annotation.Nullable ContentBodyCreate exportView) {
  ...
  public ContentCreateBody styledView(@javax.annotation.Nullable ContentBodyCreate styledView) {
  ...
  public ContentCreateBody storage(@javax.annotation.Nullable ContentBodyCreate storage) {
  ...
  public ContentCreateBody editor(@javax.annotation.Nullable ContentBodyCreate editor) {
    this.editor = editor;
    return this;
  }
  ...
  public ContentCreateBody editor2(@javax.annotation.Nullable ContentBodyCreate editor2) {
  ...
  public ContentCreateBody wiki(@javax.annotation.Nullable ContentBodyCreate wiki) {
    this.wiki = wiki;
    return this;
  }
  ...
  public ContentCreateBody anonymousExportView(@javax.annotation.Nullable ContentBodyCreate anonymousExportView) {
  ...
  public ContentCreateBody plain(@javax.annotation.Nullable ContentBodyCreate plain) {
    this.plain = plain;
    return this;
  }
  ...
  public void setPlain(@javax.annotation.Nullable ContentBodyCreate plain) {
    this.plain = plain;
  }


  public ContentCreateBody atlasDocFormat(@javax.annotation.Nullable ContentBodyCreate atlasDocFormat) {
  ...
  public ContentCreateBody raw(@javax.annotation.Nullable ContentBodyCreate raw) {
    this.raw = raw;
    return this;
  }
  ...
  public void setRaw(@javax.annotation.Nullable ContentBodyCreate raw) {
    this.raw = raw;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("view", "export_view", "styled_view", "storage", "editor", "editor2", "wiki", "anonymous_export_view", "plain", "atlas_doc_format", "raw"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentCreateBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentCreateBody is not found in the empty JSON string", ContentCreateBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentCreateBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentCreateBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
