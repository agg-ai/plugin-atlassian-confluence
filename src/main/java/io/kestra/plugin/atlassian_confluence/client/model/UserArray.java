...
public class UserArray {
  ...
  public UserArray results(@javax.annotation.Nonnull List<User> results) {
  ...
  public UserArray start(@javax.annotation.Nullable Integer start) {
    this.start = start;
    return this;
  }
  ...
  public UserArray limit(@javax.annotation.Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public UserArray size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public UserArray totalSize(@javax.annotation.Nullable Long totalSize) {
  ...
  public UserArray links(@javax.annotation.Nullable Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserArray.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UserArray is not found in the empty JSON string", UserArray.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserArray.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserArray` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
