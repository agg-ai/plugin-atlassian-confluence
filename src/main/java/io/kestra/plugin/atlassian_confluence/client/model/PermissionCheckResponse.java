...
public class PermissionCheckResponse {
  ...
  public PermissionCheckResponse hasPermission(@javax.annotation.Nonnull Boolean hasPermission) {
  ...
  public PermissionCheckResponse errors(@javax.annotation.Nullable List<Message> errors) {
    this.errors = errors;
    return this;
  }
  ...
  public PermissionCheckResponse links(@javax.annotation.Nullable Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("hasPermission", "errors", "_links"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PermissionCheckResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PermissionCheckResponse is not found in the empty JSON string", PermissionCheckResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PermissionCheckResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PermissionCheckResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
