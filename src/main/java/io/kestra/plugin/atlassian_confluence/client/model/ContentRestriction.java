...
public class ContentRestriction {
  ...
  public ContentRestriction operation(@javax.annotation.Nonnull OperationEnum operation) {
  ...
  public ContentRestriction restrictions(@javax.annotation.Nullable ContentRestrictionRestrictions restrictions) {
  ...
  public void setRestrictions(@javax.annotation.Nullable ContentRestrictionRestrictions restrictions) {
    this.restrictions = restrictions;
  }


  public ContentRestriction content(@javax.annotation.Nullable Content content) {
  ...
  public ContentRestriction expandable(@javax.annotation.Nonnull ContentRestrictionExpandable expandable) {
  ...
  public void setExpandable(@javax.annotation.Nonnull ContentRestrictionExpandable expandable) {
    this.expandable = expandable;
  }


  public ContentRestriction links(@javax.annotation.Nonnull Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("operation", "restrictions", "content", "_expandable", "_links"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("operation", "_expandable", "_links"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentRestriction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentRestriction is not found in the empty JSON string", ContentRestriction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentRestriction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentRestriction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
