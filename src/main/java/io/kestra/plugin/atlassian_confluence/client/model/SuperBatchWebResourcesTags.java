...
public class SuperBatchWebResourcesTags {
  ...
  public SuperBatchWebResourcesTags all(@javax.annotation.Nullable String all) {
    this.all = all;
    return this;
  }
  ...
  public SuperBatchWebResourcesTags css(@javax.annotation.Nullable String css) {
    this.css = css;
    return this;
  }
  ...
  public SuperBatchWebResourcesTags data(@javax.annotation.Nullable String data) {
    this.data = data;
    return this;
  }
  ...
  public SuperBatchWebResourcesTags js(@javax.annotation.Nullable String js) {
    this.js = js;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("all", "css", "data", "js"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SuperBatchWebResourcesTags.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SuperBatchWebResourcesTags is not found in the empty JSON string", SuperBatchWebResourcesTags.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SuperBatchWebResourcesTags.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SuperBatchWebResourcesTags` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
