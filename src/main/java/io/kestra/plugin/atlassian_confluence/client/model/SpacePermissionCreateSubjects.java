...
import io.kestra.plugin.atlassian_confluence.client.model.SpacePermissionCreateSubjectsGroup;
import io.kestra.plugin.atlassian_confluence.client.model.SpacePermissionCreateSubjectsUser;
...
public class SpacePermissionCreateSubjects {
  ...
  public SpacePermissionCreateSubjects user(@javax.annotation.Nullable SpacePermissionCreateSubjectsUser user) {
    this.user = user;
    return this;
  }
  ...
  public void setUser(@javax.annotation.Nullable SpacePermissionCreateSubjectsUser user) {
    this.user = user;
  }


  public SpacePermissionCreateSubjects group(@javax.annotation.Nullable SpacePermissionCreateSubjectsGroup group) {
    this.group = group;
    return this;
  }
  ...
  public void setGroup(@javax.annotation.Nullable SpacePermissionCreateSubjectsGroup group) {
    this.group = group;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SpacePermissionCreateSubjects.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SpacePermissionCreateSubjects is not found in the empty JSON string", SpacePermissionCreateSubjects.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SpacePermissionCreateSubjects.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SpacePermissionCreateSubjects` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
