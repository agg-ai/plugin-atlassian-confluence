...
public class ContentBlueprintDraft {
  ...
  public ContentBlueprintDraft version(@javax.annotation.Nonnull ContentBlueprintDraftVersion version) {
  ...
  public void setVersion(@javax.annotation.Nonnull ContentBlueprintDraftVersion version) {
    this.version = version;
  }


  public ContentBlueprintDraft title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public ContentBlueprintDraft type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ContentBlueprintDraft status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public ContentBlueprintDraft space(@javax.annotation.Nullable ContentBlueprintDraftSpace space) {
    this.space = space;
    return this;
  }
  ...
  public void setSpace(@javax.annotation.Nullable ContentBlueprintDraftSpace space) {
    this.space = space;
  }


  public ContentBlueprintDraft ancestors(@javax.annotation.Nullable List<ContentBlueprintDraftAncestorsInner> ancestors) {
  ...
  public void setAncestors(@javax.annotation.Nullable List<ContentBlueprintDraftAncestorsInner> ancestors) {
    this.ancestors = ancestors;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("version", "title", "type", "status", "space", "ancestors"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("version", "title", "type"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentBlueprintDraft.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentBlueprintDraft is not found in the empty JSON string", ContentBlueprintDraft.openapiRequiredFields.toString()));
        }
      }
