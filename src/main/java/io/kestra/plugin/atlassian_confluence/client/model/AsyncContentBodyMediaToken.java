...
public class AsyncContentBodyMediaToken {
  ...
  public AsyncContentBodyMediaToken collectionIds(@javax.annotation.Nullable List<String> collectionIds) {
  ...
  public void setCollectionIds(@javax.annotation.Nullable List<String> collectionIds) {
    this.collectionIds = collectionIds;
  }


  public AsyncContentBodyMediaToken contentId(@javax.annotation.Nullable String contentId) {
  ...
  public AsyncContentBodyMediaToken expiryDateTime(@javax.annotation.Nullable String expiryDateTime) {
  ...
  public void setExpiryDateTime(@javax.annotation.Nullable String expiryDateTime) {
    this.expiryDateTime = expiryDateTime;
  }


  public AsyncContentBodyMediaToken fileIds(@javax.annotation.Nullable List<String> fileIds) {
  ...
  public AsyncContentBodyMediaToken token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("collectionIds", "contentId", "expiryDateTime", "fileIds", "token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AsyncContentBodyMediaToken.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AsyncContentBodyMediaToken is not found in the empty JSON string", AsyncContentBodyMediaToken.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AsyncContentBodyMediaToken.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AsyncContentBodyMediaToken` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("collectionIds") != null && !jsonObj.get("collectionIds").isJsonNull() && !jsonObj.get("collectionIds").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `collectionIds` to be an array in the JSON string but got `%s`", jsonObj.get("collectionIds").toString()));
      }
      if ((jsonObj.get("contentId") != null && !jsonObj.get("contentId").isJsonNull()) && !jsonObj.get("contentId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `contentId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("contentId").toString()));
      }
      if ((jsonObj.get("expiryDateTime") != null && !jsonObj.get("expiryDateTime").isJsonNull()) && !jsonObj.get("expiryDateTime").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `expiryDateTime` to be a primitive type in the JSON string but got `%s`", jsonObj.get("expiryDateTime").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("fileIds") != null && !jsonObj.get("fileIds").isJsonNull() && !jsonObj.get("fileIds").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `fileIds` to be an array in the JSON string but got `%s`", jsonObj.get("fileIds").toString()));
      }
