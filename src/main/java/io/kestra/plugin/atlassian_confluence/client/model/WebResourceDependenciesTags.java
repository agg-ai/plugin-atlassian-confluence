...
public class WebResourceDependenciesTags {
  ...
  public WebResourceDependenciesTags all(@javax.annotation.Nullable String all) {
    this.all = all;
    return this;
  }
  ...
  public WebResourceDependenciesTags css(@javax.annotation.Nullable String css) {
    this.css = css;
    return this;
  }
  ...
  public WebResourceDependenciesTags data(@javax.annotation.Nullable String data) {
    this.data = data;
    return this;
  }
  ...
  public WebResourceDependenciesTags js(@javax.annotation.Nullable String js) {
    this.js = js;
    return this;
  }
  ...
  public void setJs(@javax.annotation.Nullable String js) {
    this.js = js;
  }


  public WebResourceDependenciesTags expandable(@javax.annotation.Nullable Map<String, Object> expandable) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("all", "css", "data", "js", "_expandable"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebResourceDependenciesTags.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WebResourceDependenciesTags is not found in the empty JSON string", WebResourceDependenciesTags.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebResourceDependenciesTags.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebResourceDependenciesTags` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("css") != null && !jsonObj.get("css").isJsonNull()) && !jsonObj.get("css").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `css` to be a primitive type in the JSON string but got `%s`", jsonObj.get("css").toString()));
      }
      ...
      if ((jsonObj.get("js") != null && !jsonObj.get("js").isJsonNull()) && !jsonObj.get("js").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `js` to be a primitive type in the JSON string but got `%s`", jsonObj.get("js").toString()));
      }
  }
