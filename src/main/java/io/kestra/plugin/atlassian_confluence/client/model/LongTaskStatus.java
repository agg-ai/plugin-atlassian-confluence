...
public class LongTaskStatus {
  ...
  public LongTaskStatus ari(@javax.annotation.Nullable String ari) {
    this.ari = ari;
    return this;
  }
  ...
  public LongTaskStatus id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public LongTaskStatus name(@javax.annotation.Nonnull LongTaskStatusName name) {
    this.name = name;
    return this;
  }
  ...
  public LongTaskStatus elapsedTime(@javax.annotation.Nonnull Long elapsedTime) {
  ...
  public LongTaskStatus percentageComplete(@javax.annotation.Nonnull Integer percentageComplete) {
  ...
  public LongTaskStatus successful(@javax.annotation.Nonnull Boolean successful) {
  ...
  public LongTaskStatus finished(@javax.annotation.Nonnull Boolean finished) {
  ...
  public LongTaskStatus messages(@javax.annotation.Nonnull List<Message> messages) {
  ...
  public LongTaskStatus status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public LongTaskStatus errors(@javax.annotation.Nullable List<Message> errors) {
    this.errors = errors;
    return this;
  }
  ...
  public LongTaskStatus additionalDetails(@javax.annotation.Nullable LongTaskStatusAdditionalDetails additionalDetails) {
  ...
  public void setAdditionalDetails(@javax.annotation.Nullable LongTaskStatusAdditionalDetails additionalDetails) {
    this.additionalDetails = additionalDetails;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ari", "id", "name", "elapsedTime", "percentageComplete", "successful", "finished", "messages", "status", "errors", "additionalDetails"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "name", "elapsedTime", "percentageComplete", "successful", "finished", "messages"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LongTaskStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in LongTaskStatus is not found in the empty JSON string", LongTaskStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LongTaskStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `LongTaskStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
