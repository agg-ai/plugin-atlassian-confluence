...
public class LookAndFeelSettings {
  ...
  public LookAndFeelSettings selected(@javax.annotation.Nonnull SelectedEnum selected) {
  ...
  public void setSelected(@javax.annotation.Nonnull SelectedEnum selected) {
    this.selected = selected;
  }


  public LookAndFeelSettings global(@javax.annotation.Nonnull LookAndFeel global) {
    this.global = global;
    return this;
  }
  ...
  public void setGlobal(@javax.annotation.Nonnull LookAndFeel global) {
    this.global = global;
  }


  public LookAndFeelSettings theme(@javax.annotation.Nullable LookAndFeel theme) {
    this.theme = theme;
    return this;
  }
  ...
  public void setTheme(@javax.annotation.Nullable LookAndFeel theme) {
    this.theme = theme;
  }


  public LookAndFeelSettings custom(@javax.annotation.Nonnull LookAndFeel custom) {
    this.custom = custom;
    return this;
  }
  ...
  public void setCustom(@javax.annotation.Nonnull LookAndFeel custom) {
    this.custom = custom;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("selected", "global", "theme", "custom"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("selected", "global", "custom"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LookAndFeelSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in LookAndFeelSettings is not found in the empty JSON string", LookAndFeelSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LookAndFeelSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `LookAndFeelSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("selected").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `selected` to be a primitive type in the JSON string but got `%s`", jsonObj.get("selected").toString()));
      }
