...
public class ContentStateSettings {
  ...
  public ContentStateSettings contentStatesAllowed(@javax.annotation.Nonnull Boolean contentStatesAllowed) {
  ...
  public void setContentStatesAllowed(@javax.annotation.Nonnull Boolean contentStatesAllowed) {
    this.contentStatesAllowed = contentStatesAllowed;
  }


  public ContentStateSettings customContentStatesAllowed(@javax.annotation.Nonnull Boolean customContentStatesAllowed) {
  ...
  public void setCustomContentStatesAllowed(@javax.annotation.Nonnull Boolean customContentStatesAllowed) {
    this.customContentStatesAllowed = customContentStatesAllowed;
  }


  public ContentStateSettings spaceContentStatesAllowed(@javax.annotation.Nonnull Boolean spaceContentStatesAllowed) {
  ...
  public void setSpaceContentStatesAllowed(@javax.annotation.Nonnull Boolean spaceContentStatesAllowed) {
    this.spaceContentStatesAllowed = spaceContentStatesAllowed;
  }


  public ContentStateSettings spaceContentStates(@javax.annotation.Nullable List<ContentState> spaceContentStates) {
  ...
  public void setSpaceContentStates(@javax.annotation.Nullable List<ContentState> spaceContentStates) {
    this.spaceContentStates = spaceContentStates;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("contentStatesAllowed", "customContentStatesAllowed", "spaceContentStatesAllowed", "spaceContentStates"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("contentStatesAllowed", "customContentStatesAllowed", "spaceContentStatesAllowed"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentStateSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentStateSettings is not found in the empty JSON string", ContentStateSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentStateSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentStateSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("spaceContentStates") != null && !jsonObj.get("spaceContentStates").isJsonNull()) {
        ...
        if (jsonArrayspaceContentStates != null) {
          ...
          if (!jsonObj.get("spaceContentStates").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `spaceContentStates` to be an array in the JSON string but got `%s`", jsonObj.get("spaceContentStates").toString()));
          }
