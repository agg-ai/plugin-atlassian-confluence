...
public class ContentLookAndFeel {
  ...
  public ContentLookAndFeel screen(@javax.annotation.Nullable ScreenLookAndFeel screen) {
    this.screen = screen;
    return this;
  }
  ...
  public void setScreen(@javax.annotation.Nullable ScreenLookAndFeel screen) {
    this.screen = screen;
  }


  public ContentLookAndFeel container(@javax.annotation.Nullable ContainerLookAndFeel container) {
  ...
  public void setContainer(@javax.annotation.Nullable ContainerLookAndFeel container) {
    this.container = container;
  }


  public ContentLookAndFeel header(@javax.annotation.Nullable ContainerLookAndFeel header) {
    this.header = header;
    return this;
  }
  ...
  public void setHeader(@javax.annotation.Nullable ContainerLookAndFeel header) {
    this.header = header;
  }


  public ContentLookAndFeel body(@javax.annotation.Nullable ContainerLookAndFeel body) {
    this.body = body;
    return this;
  }
  ...
  public void setBody(@javax.annotation.Nullable ContainerLookAndFeel body) {
    this.body = body;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("screen", "container", "header", "body"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentLookAndFeel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentLookAndFeel is not found in the empty JSON string", ContentLookAndFeel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentLookAndFeel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentLookAndFeel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
