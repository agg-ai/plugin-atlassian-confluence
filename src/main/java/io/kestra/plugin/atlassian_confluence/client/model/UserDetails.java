...
import io.kestra.plugin.atlassian_confluence.client.model.UserDetailsBusiness;
import io.kestra.plugin.atlassian_confluence.client.model.UserDetailsPersonal;
...
public class UserDetails {
  ...
  private UserDetailsBusiness business;

  public static final String SERIALIZED_NAME_PERSONAL = "personal";
  @SerializedName(SERIALIZED_NAME_PERSONAL)
  @javax.annotation.Nullable
  private UserDetailsPersonal personal;

  public UserDetails() {
  }

  public UserDetails business(@javax.annotation.Nullable UserDetailsBusiness business) {
   ...
   */
  @javax.annotation.Nullable
  public UserDetailsBusiness getBusiness() {
    return business;
  }

  public void setBusiness(@javax.annotation.Nullable UserDetailsBusiness business) {
    this.business = business;
  }


  public UserDetails personal(@javax.annotation.Nullable UserDetailsPersonal personal) {
   ...
   */
  @javax.annotation.Nullable
  public UserDetailsPersonal getPersonal() {
    return personal;
  }

  public void setPersonal(@javax.annotation.Nullable UserDetailsPersonal personal) {
    this.personal = personal;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.business, userDetails.business) &&
        Objects.equals(this.personal, userDetails.personal);
  }

  @Override
  public int hashCode() {
    return Objects.hash(business, personal);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("business", "personal"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("business") != null && !jsonObj.get("business").isJsonNull()) {
        UserDetailsBusiness.validateJsonElement(jsonObj.get("business"));
      }
      // validate the optional field `personal`
      if (jsonObj.get("personal") != null && !jsonObj.get("personal").isJsonNull()) {
        UserDetailsPersonal.validateJsonElement(jsonObj.get("personal"));
      }
  }
