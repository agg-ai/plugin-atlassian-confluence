...
import io.kestra.plugin.atlassian_confluence.client.model.ContentRestrictionUpdateRestrictionsGroupInner;
import io.kestra.plugin.atlassian_confluence.client.model.ContentRestrictionUpdateRestrictionsUser;
...
public class ContentRestrictionUpdateRestrictions {
  ...
  private List<ContentRestrictionUpdateRestrictionsGroupInner> group = new ArrayList<>();
  ...
  public ContentRestrictionUpdateRestrictions group(@javax.annotation.Nullable List<ContentRestrictionUpdateRestrictionsGroupInner> group) {
    this.group = group;
    return this;
  }
  ...
  public void setGroup(@javax.annotation.Nullable List<ContentRestrictionUpdateRestrictionsGroupInner> group) {
    this.group = group;
  }


  public ContentRestrictionUpdateRestrictions user(@javax.annotation.Nullable ContentRestrictionUpdateRestrictionsUser user) {
    this.user = user;
    return this;
  }
  ...
  public void setUser(@javax.annotation.Nullable ContentRestrictionUpdateRestrictionsUser user) {
    this.user = user;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("group", "user"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentRestrictionUpdateRestrictions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentRestrictionUpdateRestrictions is not found in the empty JSON string", ContentRestrictionUpdateRestrictions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentRestrictionUpdateRestrictions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentRestrictionUpdateRestrictions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
