...
public class ContentHistoryExpandable {
  ...
  public ContentHistoryExpandable lastUpdated(@javax.annotation.Nullable String lastUpdated) {
  ...
  public ContentHistoryExpandable previousVersion(@javax.annotation.Nullable String previousVersion) {
  ...
  public ContentHistoryExpandable contributors(@javax.annotation.Nullable String contributors) {
  ...
  public void setContributors(@javax.annotation.Nullable String contributors) {
    this.contributors = contributors;
  }


  public ContentHistoryExpandable nextVersion(@javax.annotation.Nullable String nextVersion) {
  ...
  public void setNextVersion(@javax.annotation.Nullable String nextVersion) {
    this.nextVersion = nextVersion;
  }


  public ContentHistoryExpandable ownedBy(@javax.annotation.Nullable String ownedBy) {
  ...
  public ContentHistoryExpandable lastOwnedBy(@javax.annotation.Nullable String lastOwnedBy) {
  ...
  public void setLastOwnedBy(@javax.annotation.Nullable String lastOwnedBy) {
    this.lastOwnedBy = lastOwnedBy;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("lastUpdated", "previousVersion", "contributors", "nextVersion", "ownedBy", "lastOwnedBy"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentHistoryExpandable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentHistoryExpandable is not found in the empty JSON string", ContentHistoryExpandable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentHistoryExpandable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentHistoryExpandable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("lastUpdated") != null && !jsonObj.get("lastUpdated").isJsonNull()) && !jsonObj.get("lastUpdated").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `lastUpdated` to be a primitive type in the JSON string but got `%s`", jsonObj.get("lastUpdated").toString()));
      }
      if ((jsonObj.get("previousVersion") != null && !jsonObj.get("previousVersion").isJsonNull()) && !jsonObj.get("previousVersion").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `previousVersion` to be a primitive type in the JSON string but got `%s`", jsonObj.get("previousVersion").toString()));
      }
      if ((jsonObj.get("contributors") != null && !jsonObj.get("contributors").isJsonNull()) && !jsonObj.get("contributors").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `contributors` to be a primitive type in the JSON string but got `%s`", jsonObj.get("contributors").toString()));
      }
      if ((jsonObj.get("nextVersion") != null && !jsonObj.get("nextVersion").isJsonNull()) && !jsonObj.get("nextVersion").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `nextVersion` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nextVersion").toString()));
      }
      if ((jsonObj.get("ownedBy") != null && !jsonObj.get("ownedBy").isJsonNull()) && !jsonObj.get("ownedBy").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `ownedBy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ownedBy").toString()));
      }
      if ((jsonObj.get("lastOwnedBy") != null && !jsonObj.get("lastOwnedBy").isJsonNull()) && !jsonObj.get("lastOwnedBy").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `lastOwnedBy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("lastOwnedBy").toString()));
      }
  }
