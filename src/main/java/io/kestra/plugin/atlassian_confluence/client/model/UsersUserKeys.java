...
public class UsersUserKeys {
  ...
  public UsersUserKeys users(@javax.annotation.Nullable List<User> users) {
    this.users = users;
    return this;
  }
  ...
  public UsersUserKeys userKeys(@javax.annotation.Nullable List<String> userKeys) {
  ...
  public void setUserKeys(@javax.annotation.Nullable List<String> userKeys) {
    this.userKeys = userKeys;
  }


  public UsersUserKeys links(@javax.annotation.Nullable Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("users", "userKeys", "_links"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UsersUserKeys.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UsersUserKeys is not found in the empty JSON string", UsersUserKeys.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("userKeys") != null && !jsonObj.get("userKeys").isJsonNull() && !jsonObj.get("userKeys").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `userKeys` to be an array in the JSON string but got `%s`", jsonObj.get("userKeys").toString()));
      }
  }
