...
public class ContentBodyExpandable {
  ...
  public ContentBodyExpandable editor(@javax.annotation.Nullable String editor) {
    this.editor = editor;
    return this;
  }
  ...
  public ContentBodyExpandable view(@javax.annotation.Nullable String view) {
    this.view = view;
    return this;
  }
  ...
  public ContentBodyExpandable exportView(@javax.annotation.Nullable String exportView) {
  ...
  public void setExportView(@javax.annotation.Nullable String exportView) {
    this.exportView = exportView;
  }


  public ContentBodyExpandable styledView(@javax.annotation.Nullable String styledView) {
  ...
  public void setStyledView(@javax.annotation.Nullable String styledView) {
    this.styledView = styledView;
  }


  public ContentBodyExpandable storage(@javax.annotation.Nullable String storage) {
  ...
  public ContentBodyExpandable editor2(@javax.annotation.Nullable String editor2) {
  ...
  public void setEditor2(@javax.annotation.Nullable String editor2) {
    this.editor2 = editor2;
  }


  public ContentBodyExpandable anonymousExportView(@javax.annotation.Nullable String anonymousExportView) {
  ...
  public void setAnonymousExportView(@javax.annotation.Nullable String anonymousExportView) {
    this.anonymousExportView = anonymousExportView;
  }


  public ContentBodyExpandable atlasDocFormat(@javax.annotation.Nullable String atlasDocFormat) {
  ...
  public void setAtlasDocFormat(@javax.annotation.Nullable String atlasDocFormat) {
    this.atlasDocFormat = atlasDocFormat;
  }


  public ContentBodyExpandable wiki(@javax.annotation.Nullable String wiki) {
    this.wiki = wiki;
    return this;
  }
  ...
  public void setWiki(@javax.annotation.Nullable String wiki) {
    this.wiki = wiki;
  }


  public ContentBodyExpandable dynamic(@javax.annotation.Nullable String dynamic) {
  ...
  public ContentBodyExpandable raw(@javax.annotation.Nullable String raw) {
    this.raw = raw;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("editor", "view", "export_view", "styled_view", "storage", "editor2", "anonymous_export_view", "atlas_doc_format", "wiki", "dynamic", "raw"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentBodyExpandable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentBodyExpandable is not found in the empty JSON string", ContentBodyExpandable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentBodyExpandable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentBodyExpandable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("editor") != null && !jsonObj.get("editor").isJsonNull()) && !jsonObj.get("editor").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `editor` to be a primitive type in the JSON string but got `%s`", jsonObj.get("editor").toString()));
      }
      ...
      if ((jsonObj.get("export_view") != null && !jsonObj.get("export_view").isJsonNull()) && !jsonObj.get("export_view").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `export_view` to be a primitive type in the JSON string but got `%s`", jsonObj.get("export_view").toString()));
      }
      if ((jsonObj.get("styled_view") != null && !jsonObj.get("styled_view").isJsonNull()) && !jsonObj.get("styled_view").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `styled_view` to be a primitive type in the JSON string but got `%s`", jsonObj.get("styled_view").toString()));
      }
      ...
      if ((jsonObj.get("editor2") != null && !jsonObj.get("editor2").isJsonNull()) && !jsonObj.get("editor2").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `editor2` to be a primitive type in the JSON string but got `%s`", jsonObj.get("editor2").toString()));
      }
      if ((jsonObj.get("anonymous_export_view") != null && !jsonObj.get("anonymous_export_view").isJsonNull()) && !jsonObj.get("anonymous_export_view").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `anonymous_export_view` to be a primitive type in the JSON string but got `%s`", jsonObj.get("anonymous_export_view").toString()));
      }
      if ((jsonObj.get("atlas_doc_format") != null && !jsonObj.get("atlas_doc_format").isJsonNull()) && !jsonObj.get("atlas_doc_format").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `atlas_doc_format` to be a primitive type in the JSON string but got `%s`", jsonObj.get("atlas_doc_format").toString()));
      }
      if ((jsonObj.get("wiki") != null && !jsonObj.get("wiki").isJsonNull()) && !jsonObj.get("wiki").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `wiki` to be a primitive type in the JSON string but got `%s`", jsonObj.get("wiki").toString()));
      }
