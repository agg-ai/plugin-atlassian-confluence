...
import io.kestra.plugin.atlassian_confluence.client.model.SpacePropertyExpandable;
import io.kestra.plugin.atlassian_confluence.client.model.SpacePropertyValue;
...
public class SpaceProperty {
  ...
  public SpaceProperty id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public SpaceProperty key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public SpaceProperty value(@javax.annotation.Nonnull SpacePropertyValue value) {
    this.value = value;
    return this;
  }
  ...
  public void setValue(@javax.annotation.Nonnull SpacePropertyValue value) {
    this.value = value;
  }


  public SpaceProperty version(@javax.annotation.Nullable Version version) {
  ...
  public SpaceProperty space(@javax.annotation.Nullable Space space) {
    this.space = space;
    return this;
  }
  ...
  public SpaceProperty links(@javax.annotation.Nullable Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  public SpaceProperty expandable(@javax.annotation.Nonnull SpacePropertyExpandable expandable) {
  ...
  public void setExpandable(@javax.annotation.Nonnull SpacePropertyExpandable expandable) {
    this.expandable = expandable;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "key", "value", "version", "space", "_links", "_expandable"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "key", "value", "_expandable"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SpaceProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SpaceProperty is not found in the empty JSON string", SpaceProperty.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SpaceProperty.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SpaceProperty` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
