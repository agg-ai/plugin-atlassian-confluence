...
public class GetViews200Response {
  ...
  public GetViews200Response id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public GetViews200Response count(@javax.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetViews200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetViews200Response is not found in the empty JSON string", GetViews200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetViews200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetViews200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
