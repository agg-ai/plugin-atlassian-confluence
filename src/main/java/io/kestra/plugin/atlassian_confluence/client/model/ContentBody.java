...
import io.kestra.plugin.atlassian_confluence.client.model.ContentBodyExpandable;
...
public class ContentBody {
  ...
  public ContentBody view(@javax.annotation.Nullable ContentBody view) {
    this.view = view;
    return this;
  }
  ...
  public ContentBody exportView(@javax.annotation.Nullable ContentBody exportView) {
  ...
  public ContentBody styledView(@javax.annotation.Nullable ContentBody styledView) {
  ...
  public ContentBody storage(@javax.annotation.Nullable ContentBody storage) {
  ...
  public ContentBody wiki(@javax.annotation.Nullable ContentBody wiki) {
    this.wiki = wiki;
    return this;
  }
  ...
  public ContentBody editor(@javax.annotation.Nullable ContentBody editor) {
    this.editor = editor;
    return this;
  }
  ...
  public ContentBody editor2(@javax.annotation.Nullable ContentBody editor2) {
  ...
  public ContentBody anonymousExportView(@javax.annotation.Nullable ContentBody anonymousExportView) {
  ...
  public ContentBody atlasDocFormat(@javax.annotation.Nullable ContentBody atlasDocFormat) {
  ...
  public ContentBody dynamic(@javax.annotation.Nullable ContentBody dynamic) {
  ...
  public void setDynamic(@javax.annotation.Nullable ContentBody dynamic) {
    this.dynamic = dynamic;
  }


  public ContentBody raw(@javax.annotation.Nullable ContentBody raw) {
    this.raw = raw;
    return this;
  }
  ...
  public void setRaw(@javax.annotation.Nullable ContentBody raw) {
    this.raw = raw;
  }


  public ContentBody expandable(@javax.annotation.Nullable ContentBodyExpandable expandable) {
  ...
  public void setExpandable(@javax.annotation.Nullable ContentBodyExpandable expandable) {
    this.expandable = expandable;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("view", "export_view", "styled_view", "storage", "wiki", "editor", "editor2", "anonymous_export_view", "atlas_doc_format", "dynamic", "raw", "_expandable"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentBody is not found in the empty JSON string", ContentBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
