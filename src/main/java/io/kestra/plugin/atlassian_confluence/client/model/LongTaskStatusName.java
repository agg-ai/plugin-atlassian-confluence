...
public class LongTaskStatusName {
  ...
  public LongTaskStatusName key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public LongTaskStatusName args(@javax.annotation.Nonnull List<Object> args) {
    this.args = args;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "args"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "args"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LongTaskStatusName.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in LongTaskStatusName is not found in the empty JSON string", LongTaskStatusName.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LongTaskStatusName.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `LongTaskStatusName` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
