...
import io.kestra.plugin.atlassian_confluence.client.model.ContentMetadataCurrentuser;
import io.kestra.plugin.atlassian_confluence.client.model.ContentMetadataLabels;
...
public class ContentMetadata {
  ...
  public ContentMetadata currentuser(@javax.annotation.Nullable ContentMetadataCurrentuser currentuser) {
  ...
  public void setCurrentuser(@javax.annotation.Nullable ContentMetadataCurrentuser currentuser) {
    this.currentuser = currentuser;
  }


  public ContentMetadata properties(@javax.annotation.Nullable Map<String, GenericLinksValue> properties) {
  ...
  public void setProperties(@javax.annotation.Nullable Map<String, GenericLinksValue> properties) {
    this.properties = properties;
  }


  public ContentMetadata frontend(@javax.annotation.Nullable Map<String, Object> frontend) {
  ...
  public void setFrontend(@javax.annotation.Nullable Map<String, Object> frontend) {
    this.frontend = frontend;
  }


  public ContentMetadata labels(@javax.annotation.Nullable ContentMetadataLabels labels) {
    this.labels = labels;
    return this;
  }
  ...
  public void setLabels(@javax.annotation.Nullable ContentMetadataLabels labels) {
    this.labels = labels;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("currentuser", "properties", "frontend", "labels"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentMetadata is not found in the empty JSON string", ContentMetadata.openapiRequiredFields.toString()));
        }
      }
