...
public class AsyncContentBody {
  ...
  @javax.annotation.Nullable
  private List<EmbeddedContent> embeddedContent = new ArrayList<>();
  ...
  public AsyncContentBody value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public AsyncContentBody representation(@javax.annotation.Nullable RepresentationEnum representation) {
  ...
  public void setRepresentation(@javax.annotation.Nullable RepresentationEnum representation) {
    this.representation = representation;
  }


  public AsyncContentBody renderTaskId(@javax.annotation.Nullable String renderTaskId) {
  ...
  public void setRenderTaskId(@javax.annotation.Nullable String renderTaskId) {
    this.renderTaskId = renderTaskId;
  }


  public AsyncContentBody error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public AsyncContentBody status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public AsyncContentBody embeddedContent(@javax.annotation.Nullable List<EmbeddedContent> embeddedContent) {
  ...
  public void setEmbeddedContent(@javax.annotation.Nullable List<EmbeddedContent> embeddedContent) {
    this.embeddedContent = embeddedContent;
  }


  public AsyncContentBody webresource(@javax.annotation.Nullable WebResourceDependencies webresource) {
  ...
  public void setWebresource(@javax.annotation.Nullable WebResourceDependencies webresource) {
    this.webresource = webresource;
  }


  public AsyncContentBody mediaToken(@javax.annotation.Nullable AsyncContentBodyMediaToken mediaToken) {
  ...
  public void setMediaToken(@javax.annotation.Nullable AsyncContentBodyMediaToken mediaToken) {
    this.mediaToken = mediaToken;
  }


  public AsyncContentBody expandable(@javax.annotation.Nullable AsyncContentBodyExpandable expandable) {
  ...
  public void setExpandable(@javax.annotation.Nullable AsyncContentBodyExpandable expandable) {
    this.expandable = expandable;
  }


  public AsyncContentBody links(@javax.annotation.Nullable Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("value", "representation", "renderTaskId", "error", "status", "embeddedContent", "webresource", "mediaToken", "_expandable", "_links"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AsyncContentBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AsyncContentBody is not found in the empty JSON string", AsyncContentBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AsyncContentBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AsyncContentBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("representation") != null && !jsonObj.get("representation").isJsonNull()) && !jsonObj.get("representation").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `representation` to be a primitive type in the JSON string but got `%s`", jsonObj.get("representation").toString()));
      }
      ...
      if ((jsonObj.get("renderTaskId") != null && !jsonObj.get("renderTaskId").isJsonNull()) && !jsonObj.get("renderTaskId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `renderTaskId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("renderTaskId").toString()));
      }
      ...
      if (jsonObj.get("embeddedContent") != null && !jsonObj.get("embeddedContent").isJsonNull() && !jsonObj.get("embeddedContent").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `embeddedContent` to be an array in the JSON string but got `%s`", jsonObj.get("embeddedContent").toString()));
      }
