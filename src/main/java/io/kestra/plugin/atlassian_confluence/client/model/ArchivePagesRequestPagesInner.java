...
public class ArchivePagesRequestPagesInner {
  ...
  public ArchivePagesRequestPagesInner id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ArchivePagesRequestPagesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ArchivePagesRequestPagesInner is not found in the empty JSON string", ArchivePagesRequestPagesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ArchivePagesRequestPagesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ArchivePagesRequestPagesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
