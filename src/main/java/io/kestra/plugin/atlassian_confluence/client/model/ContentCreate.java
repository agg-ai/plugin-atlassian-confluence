...
public class ContentCreate {
  ...
  public ContentCreate id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ContentCreate title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ContentCreate type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public ContentCreate space(@javax.annotation.Nullable ContentCreateSpace space) {
    this.space = space;
    return this;
  }
  ...
  public void setSpace(@javax.annotation.Nullable ContentCreateSpace space) {
    this.space = space;
  }


  public ContentCreate status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public ContentCreate container(@javax.annotation.Nullable ContentCreateContainer container) {
  ...
  public void setContainer(@javax.annotation.Nullable ContentCreateContainer container) {
    this.container = container;
  }


  public ContentCreate ancestors(@javax.annotation.Nullable List<ContentCreateAncestorsInner> ancestors) {
  ...
  public void setAncestors(@javax.annotation.Nullable List<ContentCreateAncestorsInner> ancestors) {
    this.ancestors = ancestors;
  }


  public ContentCreate body(@javax.annotation.Nullable ContentCreateBody body) {
    this.body = body;
    return this;
  }
  ...
  public void setBody(@javax.annotation.Nullable ContentCreateBody body) {
    this.body = body;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "title", "type", "space", "status", "container", "ancestors", "body"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentCreate is not found in the empty JSON string", ContentCreate.openapiRequiredFields.toString()));
        }
      }
