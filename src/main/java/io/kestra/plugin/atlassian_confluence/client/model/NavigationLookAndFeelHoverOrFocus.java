...
public class NavigationLookAndFeelHoverOrFocus {
  ...
  public NavigationLookAndFeelHoverOrFocus backgroundColor(@javax.annotation.Nonnull String backgroundColor) {
  ...
  public NavigationLookAndFeelHoverOrFocus color(@javax.annotation.Nonnull String color) {
    this.color = color;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NavigationLookAndFeelHoverOrFocus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in NavigationLookAndFeelHoverOrFocus is not found in the empty JSON string", NavigationLookAndFeelHoverOrFocus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NavigationLookAndFeelHoverOrFocus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `NavigationLookAndFeelHoverOrFocus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
