...
public class AttachmentUpdateMetadata {
  ...
  public AttachmentUpdateMetadata mediaType(@javax.annotation.Nullable String mediaType) {
  ...
  public AttachmentUpdateMetadata comment(@javax.annotation.Nullable String comment) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("mediaType", "comment"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttachmentUpdateMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AttachmentUpdateMetadata is not found in the empty JSON string", AttachmentUpdateMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttachmentUpdateMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AttachmentUpdateMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
