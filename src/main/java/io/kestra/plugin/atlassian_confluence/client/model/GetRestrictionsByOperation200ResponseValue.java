...
public class GetRestrictionsByOperation200ResponseValue {
  ...
  public GetRestrictionsByOperation200ResponseValue operationType(@javax.annotation.Nullable ContentRestriction operationType) {
  ...
  public void setOperationType(@javax.annotation.Nullable ContentRestriction operationType) {
    this.operationType = operationType;
  }


  public GetRestrictionsByOperation200ResponseValue links(@javax.annotation.Nullable Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("operationType", "_links"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRestrictionsByOperation200ResponseValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetRestrictionsByOperation200ResponseValue is not found in the empty JSON string", GetRestrictionsByOperation200ResponseValue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRestrictionsByOperation200ResponseValue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetRestrictionsByOperation200ResponseValue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
