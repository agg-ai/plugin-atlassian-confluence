...
public class GenericLinksValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GenericLinksValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GenericLinksValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GenericLinksValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GenericLinksValue>() {
                @Override
                public void write(JsonWriter out, GenericLinksValue value) throws IOException {
                ...
                @Override
                public GenericLinksValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GenericLinksValue ret = new GenericLinksValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(Locale.ROOT, "Failed deserialization for GenericLinksValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GenericLinksValue(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return GenericLinksValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GenericLinksValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(Locale.ROOT, "The JSON string is invalid for GenericLinksValue with oneOf schemas: Map<String, Object>, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of GenericLinksValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GenericLinksValue
     * @throws IOException if the JSON string is invalid with respect to GenericLinksValue
     */
    public static GenericLinksValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GenericLinksValue.class);
    }

    /**
     * Convert an instance of GenericLinksValue to an JSON string
     *
     * @return JSON string
     */
