...
public class ContentStateRestInput {
  ...
  public ContentStateRestInput name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ContentStateRestInput color(@javax.annotation.Nullable String color) {
    this.color = color;
    return this;
  }
  ...
  public ContentStateRestInput id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "color", "id"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentStateRestInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentStateRestInput is not found in the empty JSON string", ContentStateRestInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentStateRestInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentStateRestInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
