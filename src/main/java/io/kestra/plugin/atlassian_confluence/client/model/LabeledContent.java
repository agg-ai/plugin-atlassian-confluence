...
import io.kestra.plugin.atlassian_confluence.client.model.LabeledContentType;
...
public class LabeledContent {
  ...
  public LabeledContent contentType(@javax.annotation.Nonnull LabeledContentType contentType) {
  ...
  public void setContentType(@javax.annotation.Nonnull LabeledContentType contentType) {
    this.contentType = contentType;
  }


  public LabeledContent contentId(@javax.annotation.Nonnull Long contentId) {
  ...
  public LabeledContent title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("contentType", "contentId", "title"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("contentType", "contentId", "title"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LabeledContent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in LabeledContent is not found in the empty JSON string", LabeledContent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LabeledContent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `LabeledContent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
