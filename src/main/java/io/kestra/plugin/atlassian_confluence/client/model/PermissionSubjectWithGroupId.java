...
public class PermissionSubjectWithGroupId {
  ...
  public PermissionSubjectWithGroupId type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public PermissionSubjectWithGroupId identifier(@javax.annotation.Nonnull String identifier) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PermissionSubjectWithGroupId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PermissionSubjectWithGroupId is not found in the empty JSON string", PermissionSubjectWithGroupId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PermissionSubjectWithGroupId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PermissionSubjectWithGroupId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
