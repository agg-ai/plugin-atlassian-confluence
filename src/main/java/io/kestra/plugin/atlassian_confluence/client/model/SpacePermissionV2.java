...
public class SpacePermissionV2 {
  ...
  public SpacePermissionV2 id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public SpacePermissionV2 subject(@javax.annotation.Nonnull PermissionSubject subject) {
  ...
  public SpacePermissionV2 operation(@javax.annotation.Nonnull SpacePermissionV2Operation operation) {
  ...
  public SpacePermissionV2 links(@javax.annotation.Nullable Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "subject", "operation", "_links"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "subject", "operation"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SpacePermissionV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SpacePermissionV2 is not found in the empty JSON string", SpacePermissionV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SpacePermissionV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SpacePermissionV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
