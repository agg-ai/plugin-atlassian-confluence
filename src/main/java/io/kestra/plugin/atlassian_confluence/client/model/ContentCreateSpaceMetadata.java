...
public class ContentCreateSpaceMetadata {
  ...
  public ContentCreateSpaceMetadata labels(@javax.annotation.Nullable LabelArray labels) {
    this.labels = labels;
    return this;
  }
  ...
  public ContentCreateSpaceMetadata expandable(@javax.annotation.Nullable Object expandable) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentCreateSpaceMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentCreateSpaceMetadata is not found in the empty JSON string", ContentCreateSpaceMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentCreateSpaceMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentCreateSpaceMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
