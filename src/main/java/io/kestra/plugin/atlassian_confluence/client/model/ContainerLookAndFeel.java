...
public class ContainerLookAndFeel {
  ...
  public ContainerLookAndFeel background(@javax.annotation.Nonnull String background) {
  ...
  public ContainerLookAndFeel backgroundAttachment(@javax.annotation.Nullable String backgroundAttachment) {
  ...
  public ContainerLookAndFeel backgroundBlendMode(@javax.annotation.Nullable String backgroundBlendMode) {
  ...
  public ContainerLookAndFeel backgroundClip(@javax.annotation.Nullable String backgroundClip) {
  ...
  public ContainerLookAndFeel backgroundColor(@javax.annotation.Nullable String backgroundColor) {
  ...
  public ContainerLookAndFeel backgroundImage(@javax.annotation.Nullable String backgroundImage) {
  ...
  public ContainerLookAndFeel backgroundOrigin(@javax.annotation.Nullable String backgroundOrigin) {
  ...
  public ContainerLookAndFeel backgroundPosition(@javax.annotation.Nullable String backgroundPosition) {
  ...
  public ContainerLookAndFeel backgroundRepeat(@javax.annotation.Nullable String backgroundRepeat) {
  ...
  public ContainerLookAndFeel backgroundSize(@javax.annotation.Nullable String backgroundSize) {
  ...
  public ContainerLookAndFeel padding(@javax.annotation.Nonnull String padding) {
  ...
  public void setPadding(@javax.annotation.Nonnull String padding) {
    this.padding = padding;
  }


  public ContainerLookAndFeel borderRadius(@javax.annotation.Nonnull String borderRadius) {
  ...
  public void setBorderRadius(@javax.annotation.Nonnull String borderRadius) {
    this.borderRadius = borderRadius;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("background", "backgroundAttachment", "backgroundBlendMode", "backgroundClip", "backgroundColor", "backgroundImage", "backgroundOrigin", "backgroundPosition", "backgroundRepeat", "backgroundSize", "padding", "borderRadius"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("background", "backgroundColor", "backgroundImage", "backgroundSize", "padding", "borderRadius"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContainerLookAndFeel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContainerLookAndFeel is not found in the empty JSON string", ContainerLookAndFeel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContainerLookAndFeel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContainerLookAndFeel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("borderRadius").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `borderRadius` to be a primitive type in the JSON string but got `%s`", jsonObj.get("borderRadius").toString()));
      }
  }
