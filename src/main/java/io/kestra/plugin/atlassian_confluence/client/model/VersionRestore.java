...
import io.kestra.plugin.atlassian_confluence.client.model.VersionRestoreParams;
...
public class VersionRestore {
  ...
  public VersionRestore operationKey(@javax.annotation.Nonnull OperationKeyEnum operationKey) {
  ...
  public void setOperationKey(@javax.annotation.Nonnull OperationKeyEnum operationKey) {
    this.operationKey = operationKey;
  }


  public VersionRestore params(@javax.annotation.Nonnull VersionRestoreParams params) {
    this.params = params;
    return this;
  }
  ...
  public void setParams(@javax.annotation.Nonnull VersionRestoreParams params) {
    this.params = params;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("operationKey", "params"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("operationKey", "params"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VersionRestore.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in VersionRestore is not found in the empty JSON string", VersionRestore.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VersionRestore.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VersionRestore` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("operationKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `operationKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("operationKey").toString()));
      }
