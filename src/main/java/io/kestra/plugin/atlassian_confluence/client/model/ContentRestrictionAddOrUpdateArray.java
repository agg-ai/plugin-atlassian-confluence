...
import io.kestra.plugin.atlassian_confluence.client.model.ContentRestrictionAddOrUpdateArrayOneOf;
...
public class ContentRestrictionAddOrUpdateArray extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final Type typeInstanceListContentRestrictionUpdate = new TypeToken<List<ContentRestrictionUpdate>>(){}.getType();
            final TypeAdapter<List<ContentRestrictionUpdate>> adapterListContentRestrictionUpdate = (TypeAdapter<List<ContentRestrictionUpdate>>) gson.getDelegateAdapter(this, TypeToken.get(typeInstanceListContentRestrictionUpdate));
            ...
            return (TypeAdapter<T>) new TypeAdapter<ContentRestrictionAddOrUpdateArray>() {
                ...
                public void write(JsonWriter out, ContentRestrictionAddOrUpdateArray value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof List<?>) {
                        ...
                        if (!list.isEmpty() && list.get(0) instanceof ContentRestrictionUpdate) {
                            JsonArray array = adapterListContentRestrictionUpdate.toJsonTree((List<ContentRestrictionUpdate>)value.getActualInstance()).getAsJsonArray();
                ...
                public ContentRestrictionAddOrUpdateArray read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(Locale.ROOT, "Deserialization for ContentRestrictionAddOrUpdateArrayOneOf failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        actualAdapter = adapterListContentRestrictionUpdate;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'List<ContentRestrictionUpdate>'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT, "Deserialization for List<ContentRestrictionUpdate> failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(Locale.ROOT, "Failed deserialization for ContentRestrictionAddOrUpdateArray: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ContentRestrictionAddOrUpdateArray(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
     ...
     */
    public List<ContentRestrictionUpdate> getListContentRestrictionUpdate() throws ClassCastException {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(Locale.ROOT, "The JSON string is invalid for ContentRestrictionAddOrUpdateArray with oneOf schemas: ContentRestrictionAddOrUpdateArrayOneOf, List<ContentRestrictionUpdate>. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
