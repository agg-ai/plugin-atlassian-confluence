...
public class GlobalSpaceIdentifier {
  ...
  public GlobalSpaceIdentifier spaceIdentifier(@javax.annotation.Nonnull String spaceIdentifier) {
  ...
  public void setSpaceIdentifier(@javax.annotation.Nonnull String spaceIdentifier) {
    this.spaceIdentifier = spaceIdentifier;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("spaceIdentifier"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("spaceIdentifier"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GlobalSpaceIdentifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GlobalSpaceIdentifier is not found in the empty JSON string", GlobalSpaceIdentifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GlobalSpaceIdentifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GlobalSpaceIdentifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("spaceIdentifier").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `spaceIdentifier` to be a primitive type in the JSON string but got `%s`", jsonObj.get("spaceIdentifier").toString()));
      }
  }
