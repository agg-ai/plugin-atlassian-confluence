...
public class SpaceDescription {
  ...
  public SpaceDescription plain(@javax.annotation.Nullable SpaceDescription plain) {
    this.plain = plain;
    return this;
  }
  ...
  public SpaceDescription view(@javax.annotation.Nullable SpaceDescription view) {
    this.view = view;
    return this;
  }
  ...
  public SpaceDescription expandable(@javax.annotation.Nullable ContentCreateSpaceDescriptionExpandable expandable) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SpaceDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SpaceDescription is not found in the empty JSON string", SpaceDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SpaceDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SpaceDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
