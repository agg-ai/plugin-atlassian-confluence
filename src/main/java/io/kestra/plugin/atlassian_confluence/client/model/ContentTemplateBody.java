...
public class ContentTemplateBody {
  ...
  public ContentTemplateBody() {
  }

  public ContentTemplateBody view(@javax.annotation.Nullable ContentBody view) {
    this.view = view;
    return this;
  }
  ...
  public void setView(@javax.annotation.Nullable ContentBody view) {
    this.view = view;
  }


  public ContentTemplateBody exportView(@javax.annotation.Nullable ContentBody exportView) {
  ...
  public void setExportView(@javax.annotation.Nullable ContentBody exportView) {
    this.exportView = exportView;
  }


  public ContentTemplateBody styledView(@javax.annotation.Nullable ContentBody styledView) {
  ...
  public void setStyledView(@javax.annotation.Nullable ContentBody styledView) {
    this.styledView = styledView;
  }


  public ContentTemplateBody storage(@javax.annotation.Nullable ContentBody storage) {
  ...
  public void setStorage(@javax.annotation.Nullable ContentBody storage) {
    this.storage = storage;
  }


  public ContentTemplateBody editor(@javax.annotation.Nullable ContentBody editor) {
    this.editor = editor;
    return this;
  }
  ...
  public void setEditor(@javax.annotation.Nullable ContentBody editor) {
    this.editor = editor;
  }


  public ContentTemplateBody editor2(@javax.annotation.Nullable ContentBody editor2) {
  ...
  public void setEditor2(@javax.annotation.Nullable ContentBody editor2) {
    this.editor2 = editor2;
  }


  public ContentTemplateBody wiki(@javax.annotation.Nullable ContentBody wiki) {
    this.wiki = wiki;
    return this;
  }
  ...
  public void setWiki(@javax.annotation.Nullable ContentBody wiki) {
    this.wiki = wiki;
  }


  public ContentTemplateBody atlasDocFormat(@javax.annotation.Nullable ContentBody atlasDocFormat) {
  ...
  public void setAtlasDocFormat(@javax.annotation.Nullable ContentBody atlasDocFormat) {
    this.atlasDocFormat = atlasDocFormat;
  }


  public ContentTemplateBody anonymousExportView(@javax.annotation.Nullable ContentBody anonymousExportView) {
  ...
  public void setAnonymousExportView(@javax.annotation.Nullable ContentBody anonymousExportView) {
    this.anonymousExportView = anonymousExportView;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContentTemplateBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentTemplateBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentTemplateBody is not found in the empty JSON string", ContentTemplateBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentTemplateBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentTemplateBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContentTemplateBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContentTemplateBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContentTemplateBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContentTemplateBody.class));

       return (TypeAdapter<T>) new TypeAdapter<ContentTemplateBody>() {
           @Override
           public void write(JsonWriter out, ContentTemplateBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContentTemplateBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContentTemplateBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContentTemplateBody
   * @throws IOException if the JSON string is invalid with respect to ContentTemplateBody
   */
  public static ContentTemplateBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContentTemplateBody.class);
  }

  /**
   * Convert an instance of ContentTemplateBody to an JSON string
   *
   * @return JSON string
   */
