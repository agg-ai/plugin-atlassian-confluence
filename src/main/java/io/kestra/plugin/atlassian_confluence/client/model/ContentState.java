...
public class ContentState {
  ...
  public ContentState id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public ContentState name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ContentState color(@javax.annotation.Nonnull String color) {
    this.color = color;
    return this;
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "name", "color"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentState.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentState is not found in the empty JSON string", ContentState.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentState.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentState` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
