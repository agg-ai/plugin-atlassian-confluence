...
public class BulkUserLookup {
  ...
  public BulkUserLookup type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public BulkUserLookup username(@javax.annotation.Nullable String username) {
  ...
  public BulkUserLookup userKey(@javax.annotation.Nullable String userKey) {
  ...
  public BulkUserLookup accountId(@javax.annotation.Nullable String accountId) {
  ...
  public BulkUserLookup accountType(@javax.annotation.Nonnull String accountType) {
  ...
  public BulkUserLookup email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public BulkUserLookup publicName(@javax.annotation.Nonnull String publicName) {
  ...
  public void setPublicName(@javax.annotation.Nonnull String publicName) {
    this.publicName = publicName;
  }


  public BulkUserLookup profilePicture(@javax.annotation.Nullable Icon profilePicture) {
  ...
  public BulkUserLookup displayName(@javax.annotation.Nonnull String displayName) {
  ...
  public BulkUserLookup timeZone(@javax.annotation.Nullable String timeZone) {
  ...
  public BulkUserLookup isExternalCollaborator(@javax.annotation.Nullable Boolean isExternalCollaborator) {
  ...
  public BulkUserLookup isGuest(@javax.annotation.Nullable Boolean isGuest) {
  ...
  public BulkUserLookup operations(@javax.annotation.Nullable List<OperationCheckResult> operations) {
  ...
  public BulkUserLookup details(@javax.annotation.Nullable UserDetails details) {
  ...
  public BulkUserLookup personalSpace(@javax.annotation.Nullable Space personalSpace) {
  ...
  public BulkUserLookup expandable(@javax.annotation.Nonnull BulkUserLookupExpandable expandable) {
  ...
  public void setExpandable(@javax.annotation.Nonnull BulkUserLookupExpandable expandable) {
    this.expandable = expandable;
  }


  public BulkUserLookup links(@javax.annotation.Nonnull Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, bulkUserLookup.type) &&
        ...
        Objects.equals(this.isGuest, bulkUserLookup.isGuest) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, username, userKey, accountId, accountType, email, publicName, profilePicture, displayName, timeZone, isExternalCollaborator, isGuest, operations, details, personalSpace, expandable, links);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "username", "userKey", "accountId", "accountType", "email", "publicName", "profilePicture", "displayName", "timeZone", "isExternalCollaborator", "isGuest", "operations", "details", "personalSpace", "_expandable", "_links"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "accountId", "accountType", "email", "publicName", "profilePicture", "displayName", "_expandable", "_links"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BulkUserLookup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in BulkUserLookup is not found in the empty JSON string", BulkUserLookup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BulkUserLookup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BulkUserLookup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
