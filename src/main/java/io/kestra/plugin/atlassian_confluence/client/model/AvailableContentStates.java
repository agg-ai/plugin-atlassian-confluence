...
public class AvailableContentStates {
  ...
  public AvailableContentStates spaceContentStates(@javax.annotation.Nonnull List<ContentState> spaceContentStates) {
  ...
  public void setSpaceContentStates(@javax.annotation.Nonnull List<ContentState> spaceContentStates) {
    this.spaceContentStates = spaceContentStates;
  }


  public AvailableContentStates customContentStates(@javax.annotation.Nonnull List<ContentState> customContentStates) {
  ...
  public void setCustomContentStates(@javax.annotation.Nonnull List<ContentState> customContentStates) {
    this.customContentStates = customContentStates;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("spaceContentStates", "customContentStates"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("spaceContentStates", "customContentStates"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AvailableContentStates.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AvailableContentStates is not found in the empty JSON string", AvailableContentStates.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AvailableContentStates.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AvailableContentStates` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("customContentStates") == null) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `customContentStates` to be an array in the JSON string but got `%s`", jsonObj.get("customContentStates").toString()));
      }
  }
