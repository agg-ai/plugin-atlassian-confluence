...
import io.kestra.plugin.atlassian_confluence.client.model.UserAnonymousExpandable;
...
public class UserAnonymous {
  ...
  public UserAnonymous type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public UserAnonymous profilePicture(@javax.annotation.Nullable Icon profilePicture) {
  ...
  public UserAnonymous displayName(@javax.annotation.Nonnull String displayName) {
  ...
  public UserAnonymous operations(@javax.annotation.Nullable List<OperationCheckResult> operations) {
  ...
  public UserAnonymous expandable(@javax.annotation.Nullable UserAnonymousExpandable expandable) {
  ...
  public void setExpandable(@javax.annotation.Nullable UserAnonymousExpandable expandable) {
    this.expandable = expandable;
  }


  public UserAnonymous links(@javax.annotation.Nonnull Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, profilePicture, displayName, operations, expandable, links);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "profilePicture", "displayName", "operations", "_expandable", "_links"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "profilePicture", "displayName", "_links"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserAnonymous.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UserAnonymous is not found in the empty JSON string", UserAnonymous.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserAnonymous.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserAnonymous` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
