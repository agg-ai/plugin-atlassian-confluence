...
public class ContentChildTypeExpandable {
  ...
  public ContentChildTypeExpandable all(@javax.annotation.Nullable String all) {
    this.all = all;
    return this;
  }
  ...
  public ContentChildTypeExpandable attachment(@javax.annotation.Nullable String attachment) {
  ...
  public ContentChildTypeExpandable comment(@javax.annotation.Nullable String comment) {
  ...
  public ContentChildTypeExpandable page(@javax.annotation.Nullable String page) {
    this.page = page;
    return this;
  }
  ...
  public ContentChildTypeExpandable whiteboard(@javax.annotation.Nullable String whiteboard) {
  ...
  public ContentChildTypeExpandable database(@javax.annotation.Nullable String database) {
  ...
  public ContentChildTypeExpandable embed(@javax.annotation.Nullable String embed) {
    this.embed = embed;
    return this;
  }
  ...
  public ContentChildTypeExpandable folder(@javax.annotation.Nullable String folder) {
    this.folder = folder;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.all, contentChildTypeExpandable.all) &&
        ...
        Objects.equals(this.database, contentChildTypeExpandable.database) &&
        Objects.equals(this.embed, contentChildTypeExpandable.embed) &&
        Objects.equals(this.folder, contentChildTypeExpandable.folder);
  }

  @Override
  public int hashCode() {
    return Objects.hash(all, attachment, comment, page, whiteboard, database, embed, folder);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("all", "attachment", "comment", "page", "whiteboard", "database", "embed", "folder"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentChildTypeExpandable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentChildTypeExpandable is not found in the empty JSON string", ContentChildTypeExpandable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentChildTypeExpandable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentChildTypeExpandable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("all") != null && !jsonObj.get("all").isJsonNull()) && !jsonObj.get("all").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `all` to be a primitive type in the JSON string but got `%s`", jsonObj.get("all").toString()));
      }
