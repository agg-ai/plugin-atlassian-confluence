...
public class Icon {
  ...
  public Icon path(@javax.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public Icon width(@javax.annotation.Nonnull Integer width) {
    this.width = width;
    return this;
  }
  ...
  public Icon height(@javax.annotation.Nonnull Integer height) {
    this.height = height;
    return this;
  }
  ...
  public Icon isDefault(@javax.annotation.Nonnull Boolean isDefault) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("path", "width", "height", "isDefault"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("path", "width", "height", "isDefault"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Icon.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Icon` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
