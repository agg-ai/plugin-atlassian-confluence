...
public class AddLabelsToContentRequest extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final Type typeInstanceListLabelCreate = new TypeToken<List<LabelCreate>>(){}.getType();
            final TypeAdapter<List<LabelCreate>> adapterListLabelCreate = (TypeAdapter<List<LabelCreate>>) gson.getDelegateAdapter(this, TypeToken.get(typeInstanceListLabelCreate));
            ...
            return (TypeAdapter<T>) new TypeAdapter<AddLabelsToContentRequest>() {
                ...
                public void write(JsonWriter out, AddLabelsToContentRequest value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof List<?>) {
                        ...
                        if (!list.isEmpty() && list.get(0) instanceof LabelCreate) {
                            JsonArray array = adapterListLabelCreate.toJsonTree((List<LabelCreate>)value.getActualInstance()).getAsJsonArray();
                ...
                public AddLabelsToContentRequest read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        actualAdapter = adapterListLabelCreate;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'List<LabelCreate>'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT, "Deserialization for List<LabelCreate> failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT, "Deserialization for LabelCreate failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(Locale.ROOT, "Failed deserialization for AddLabelsToContentRequest: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AddLabelsToContentRequest(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
     ...
     */
    public List<LabelCreate> getListLabelCreate() throws ClassCastException {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(Locale.ROOT, "The JSON string is invalid for AddLabelsToContentRequest with oneOf schemas: LabelCreate, List<LabelCreate>. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
