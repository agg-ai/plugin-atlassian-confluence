...
public class AuditRecordCreate {
  ...
  public AuditRecordCreate author(@javax.annotation.Nullable AuditRecordCreateAuthor author) {
    this.author = author;
    return this;
  }
  ...
  public void setAuthor(@javax.annotation.Nullable AuditRecordCreateAuthor author) {
    this.author = author;
  }


  public AuditRecordCreate remoteAddress(@javax.annotation.Nonnull String remoteAddress) {
  ...
  public AuditRecordCreate creationDate(@javax.annotation.Nullable Long creationDate) {
  ...
  public AuditRecordCreate summary(@javax.annotation.Nullable String summary) {
  ...
  public AuditRecordCreate description(@javax.annotation.Nullable String description) {
  ...
  public AuditRecordCreate category(@javax.annotation.Nullable String category) {
  ...
  public AuditRecordCreate sysAdmin(@javax.annotation.Nullable Boolean sysAdmin) {
  ...
  public void setSysAdmin(@javax.annotation.Nullable Boolean sysAdmin) {
    this.sysAdmin = sysAdmin;
  }


  public AuditRecordCreate affectedObject(@javax.annotation.Nullable AffectedObject affectedObject) {
  ...
  public void setAffectedObject(@javax.annotation.Nullable AffectedObject affectedObject) {
    this.affectedObject = affectedObject;
  }


  public AuditRecordCreate changedValues(@javax.annotation.Nullable List<ChangedValue> changedValues) {
  ...
  public void setChangedValues(@javax.annotation.Nullable List<ChangedValue> changedValues) {
    this.changedValues = changedValues;
  }


  public AuditRecordCreate associatedObjects(@javax.annotation.Nullable List<AffectedObject> associatedObjects) {
  ...
  public void setAssociatedObjects(@javax.annotation.Nullable List<AffectedObject> associatedObjects) {
    this.associatedObjects = associatedObjects;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("author", "remoteAddress", "creationDate", "summary", "description", "category", "sysAdmin", "affectedObject", "changedValues", "associatedObjects"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("remoteAddress"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuditRecordCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AuditRecordCreate is not found in the empty JSON string", AuditRecordCreate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuditRecordCreate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuditRecordCreate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
