...
public class GroupArrayWithLinks {
  ...
  public GroupArrayWithLinks results(@javax.annotation.Nonnull List<Group> results) {
  ...
  public GroupArrayWithLinks start(@javax.annotation.Nonnull Integer start) {
    this.start = start;
    return this;
  }
  ...
  public GroupArrayWithLinks limit(@javax.annotation.Nonnull Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public GroupArrayWithLinks size(@javax.annotation.Nonnull Integer size) {
    this.size = size;
    return this;
  }
  ...
  public GroupArrayWithLinks totalSize(@javax.annotation.Nullable Long totalSize) {
  ...
  public GroupArrayWithLinks links(@javax.annotation.Nonnull Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("results", "start", "limit", "size", "totalSize", "_links"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GroupArrayWithLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GroupArrayWithLinks is not found in the empty JSON string", GroupArrayWithLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GroupArrayWithLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GroupArrayWithLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
