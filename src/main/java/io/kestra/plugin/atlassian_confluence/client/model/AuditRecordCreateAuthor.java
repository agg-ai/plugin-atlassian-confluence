...
public class AuditRecordCreateAuthor {
  ...
  public AuditRecordCreateAuthor type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AuditRecordCreateAuthor displayName(@javax.annotation.Nullable String displayName) {
  ...
  public AuditRecordCreateAuthor operations(@javax.annotation.Nullable List<OperationCheckResult> operations) {
    this.operations = operations;
    return this;
  }

  public AuditRecordCreateAuthor addOperationsItem(OperationCheckResult operationsItem) {
  ...
  public AuditRecordCreateAuthor username(@javax.annotation.Nullable String username) {
  ...
  public AuditRecordCreateAuthor userKey(@javax.annotation.Nullable String userKey) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "displayName", "operations", "username", "userKey"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuditRecordCreateAuthor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AuditRecordCreateAuthor is not found in the empty JSON string", AuditRecordCreateAuthor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuditRecordCreateAuthor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuditRecordCreateAuthor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
