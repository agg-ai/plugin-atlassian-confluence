...
public class Version {
  ...
  public Version by(@javax.annotation.Nullable User by) {
    this.by = by;
    return this;
  }
  ...
  public void setBy(@javax.annotation.Nullable User by) {
    this.by = by;
  }


  public Version when(@javax.annotation.Nullable OffsetDateTime when) {
    this.when = when;
    return this;
  }
  ...
  public Version friendlyWhen(@javax.annotation.Nullable String friendlyWhen) {
  ...
  public void setFriendlyWhen(@javax.annotation.Nullable String friendlyWhen) {
    this.friendlyWhen = friendlyWhen;
  }


  public Version message(@javax.annotation.Nullable String message) {
  ...
  public Version number(@javax.annotation.Nonnull Integer number) {
    this.number = number;
    return this;
  }
  ...
  public Version minorEdit(@javax.annotation.Nonnull Boolean minorEdit) {
  ...
  public void setMinorEdit(@javax.annotation.Nonnull Boolean minorEdit) {
    this.minorEdit = minorEdit;
  }


  public Version content(@javax.annotation.Nullable Content content) {
  ...
  public Version collaborators(@javax.annotation.Nullable UsersUserKeys collaborators) {
  ...
  public void setCollaborators(@javax.annotation.Nullable UsersUserKeys collaborators) {
    this.collaborators = collaborators;
  }


  public Version expandable(@javax.annotation.Nullable VersionExpandable expandable) {
  ...
  public void setExpandable(@javax.annotation.Nullable VersionExpandable expandable) {
    this.expandable = expandable;
  }


  public Version links(@javax.annotation.Nullable Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  public Version contentTypeModified(@javax.annotation.Nullable Boolean contentTypeModified) {
  ...
  public void setContentTypeModified(@javax.annotation.Nullable Boolean contentTypeModified) {
    this.contentTypeModified = contentTypeModified;
  }


  public Version confRev(@javax.annotation.Nullable String confRev) {
  ...
  public void setConfRev(@javax.annotation.Nullable String confRev) {
    this.confRev = confRev;
  }


  public Version syncRev(@javax.annotation.Nullable String syncRev) {
  ...
  public void setSyncRev(@javax.annotation.Nullable String syncRev) {
    this.syncRev = syncRev;
  }


  public Version syncRevSource(@javax.annotation.Nullable String syncRevSource) {
  ...
  public void setSyncRevSource(@javax.annotation.Nullable String syncRevSource) {
    this.syncRevSource = syncRevSource;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("by", "when", "friendlyWhen", "message", "number", "minorEdit", "content", "collaborators", "_expandable", "_links", "contentTypeModified", "confRev", "syncRev", "syncRevSource"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("when", "number", "minorEdit"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("friendlyWhen") != null && !jsonObj.get("friendlyWhen").isJsonNull()) && !jsonObj.get("friendlyWhen").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `friendlyWhen` to be a primitive type in the JSON string but got `%s`", jsonObj.get("friendlyWhen").toString()));
      }
      ...
      if ((jsonObj.get("confRev") != null && !jsonObj.get("confRev").isJsonNull()) && !jsonObj.get("confRev").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `confRev` to be a primitive type in the JSON string but got `%s`", jsonObj.get("confRev").toString()));
      }
      if ((jsonObj.get("syncRev") != null && !jsonObj.get("syncRev").isJsonNull()) && !jsonObj.get("syncRev").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `syncRev` to be a primitive type in the JSON string but got `%s`", jsonObj.get("syncRev").toString()));
      }
      if ((jsonObj.get("syncRevSource") != null && !jsonObj.get("syncRevSource").isJsonNull()) && !jsonObj.get("syncRevSource").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `syncRevSource` to be a primitive type in the JSON string but got `%s`", jsonObj.get("syncRevSource").toString()));
      }
  }
