...
public class WatchUser {
  ...
  public WatchUser type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public WatchUser username(@javax.annotation.Nullable String username) {
  ...
  public WatchUser userKey(@javax.annotation.Nullable String userKey) {
  ...
  public WatchUser accountId(@javax.annotation.Nullable String accountId) {
  ...
  public WatchUser profilePicture(@javax.annotation.Nullable Icon profilePicture) {
  ...
  public WatchUser displayName(@javax.annotation.Nonnull String displayName) {
  ...
  public WatchUser timeZone(@javax.annotation.Nullable String timeZone) {
  ...
  public WatchUser operations(@javax.annotation.Nullable List<OperationCheckResult> operations) {
  ...
  public WatchUser externalCollaborator(@javax.annotation.Nonnull Boolean externalCollaborator) {
  ...
  public void setExternalCollaborator(@javax.annotation.Nonnull Boolean externalCollaborator) {
    this.externalCollaborator = externalCollaborator;
  }


  public WatchUser isGuest(@javax.annotation.Nullable Boolean isGuest) {
  ...
  public WatchUser isExternalCollaborator(@javax.annotation.Nonnull Boolean isExternalCollaborator) {
  ...
  public void setIsExternalCollaborator(@javax.annotation.Nonnull Boolean isExternalCollaborator) {
    this.isExternalCollaborator = isExternalCollaborator;
  }


  public WatchUser details(@javax.annotation.Nullable UserDetails details) {
  ...
  public WatchUser accountType(@javax.annotation.Nonnull String accountType) {
  ...
  public WatchUser email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public WatchUser publicName(@javax.annotation.Nonnull String publicName) {
  ...
  public WatchUser personalSpace(@javax.annotation.Nullable Object personalSpace) {
  ...
  public void setPersonalSpace(@javax.annotation.Nullable Object personalSpace) {
    this.personalSpace = personalSpace;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, watchUser.type) &&
        ...
        Objects.equals(this.isGuest, watchUser.isGuest) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, username, userKey, accountId, profilePicture, displayName, timeZone, operations, externalCollaborator, isGuest, isExternalCollaborator, details, accountType, email, publicName, personalSpace);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "username", "userKey", "accountId", "profilePicture", "displayName", "timeZone", "operations", "externalCollaborator", "isGuest", "isExternalCollaborator", "details", "accountType", "email", "publicName", "personalSpace"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "accountId", "profilePicture", "displayName", "operations", "externalCollaborator", "isGuest", "isExternalCollaborator", "accountType", "email", "publicName", "personalSpace"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatchUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WatchUser is not found in the empty JSON string", WatchUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WatchUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WatchUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
