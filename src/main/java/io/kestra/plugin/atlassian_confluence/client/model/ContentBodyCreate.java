...
public class ContentBodyCreate {
  ...
  public ContentBodyCreate value(@javax.annotation.Nonnull String value) {
    this.value = value;
    return this;
  }
  ...
  public ContentBodyCreate representation(@javax.annotation.Nonnull RepresentationEnum representation) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentBodyCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentBodyCreate is not found in the empty JSON string", ContentBodyCreate.openapiRequiredFields.toString()));
        }
      }
