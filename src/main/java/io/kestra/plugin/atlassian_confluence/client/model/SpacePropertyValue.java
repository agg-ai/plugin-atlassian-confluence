...
public class SpacePropertyValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SpacePropertyValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SpacePropertyValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SpacePropertyValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SpacePropertyValue>() {
                @Override
                public void write(JsonWriter out, SpacePropertyValue value) throws IOException {
                ...
                @Override
                public SpacePropertyValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        SpacePropertyValue ret = new SpacePropertyValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(Locale.ROOT, "Failed deserialization for SpacePropertyValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SpacePropertyValue(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return SpacePropertyValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to SpacePropertyValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(Locale.ROOT, "The JSON string is invalid for SpacePropertyValue with oneOf schemas: Boolean, List<String>, Map<String, Object>, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of SpacePropertyValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of SpacePropertyValue
     * @throws IOException if the JSON string is invalid with respect to SpacePropertyValue
     */
    public static SpacePropertyValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, SpacePropertyValue.class);
    }

    /**
     * Convert an instance of SpacePropertyValue to an JSON string
     *
     * @return JSON string
     */
