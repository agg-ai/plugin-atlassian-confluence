...
public class CQLPersonalDataMigrationRequest {
  ...
  public CQLPersonalDataMigrationRequest queryStrings(@javax.annotation.Nonnull List<String> queryStrings) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CQLPersonalDataMigrationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CQLPersonalDataMigrationRequest is not found in the empty JSON string", CQLPersonalDataMigrationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CQLPersonalDataMigrationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CQLPersonalDataMigrationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
