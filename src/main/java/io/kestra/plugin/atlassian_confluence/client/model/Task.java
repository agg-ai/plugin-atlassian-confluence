...
public class Task {
  ...
  public Task globalId(@javax.annotation.Nonnull Long globalId) {
  ...
  public Task id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public Task contentId(@javax.annotation.Nonnull Long contentId) {
  ...
  public Task status(@javax.annotation.Nonnull String status) {
    this.status = status;
    return this;
  }
  ...
  public Task body(@javax.annotation.Nullable String body) {
    this.body = body;
    return this;
  }
  ...
  public Task creator(@javax.annotation.Nonnull String creator) {
  ...
  public void setCreator(@javax.annotation.Nonnull String creator) {
    this.creator = creator;
  }
  ...
  public Task completeUser(@javax.annotation.Nullable String completeUser) {
  ...
  public void setCompleteUser(@javax.annotation.Nullable String completeUser) {
    this.completeUser = completeUser;
  }


  public Task createDate(@javax.annotation.Nonnull Long createDate) {
  ...
  public void setCreateDate(@javax.annotation.Nonnull Long createDate) {
    this.createDate = createDate;
  }


  public Task dueDate(@javax.annotation.Nullable Long dueDate) {
  ...
  public Task updateDate(@javax.annotation.Nullable Long updateDate) {
  ...
  public void setUpdateDate(@javax.annotation.Nullable Long updateDate) {
    this.updateDate = updateDate;
  }


  public Task completeDate(@javax.annotation.Nullable Long completeDate) {
  ...
  public void setCompleteDate(@javax.annotation.Nullable Long completeDate) {
    this.completeDate = completeDate;
  }


  public Task links(@javax.annotation.Nullable Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("globalId", "id", "contentId", "status", "title", "description", "body", "creator", "assignee", "completeUser", "createDate", "dueDate", "updateDate", "completeDate", "_links"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("globalId", "id", "contentId", "status", "creator", "createDate"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Task.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Task is not found in the empty JSON string", Task.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Task.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Task` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("creator").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `creator` to be a primitive type in the JSON string but got `%s`", jsonObj.get("creator").toString()));
      }
      if ((jsonObj.get("assignee") != null && !jsonObj.get("assignee").isJsonNull()) && !jsonObj.get("assignee").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `assignee` to be a primitive type in the JSON string but got `%s`", jsonObj.get("assignee").toString()));
      }
      if ((jsonObj.get("completeUser") != null && !jsonObj.get("completeUser").isJsonNull()) && !jsonObj.get("completeUser").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `completeUser` to be a primitive type in the JSON string but got `%s`", jsonObj.get("completeUser").toString()));
      }
  }
