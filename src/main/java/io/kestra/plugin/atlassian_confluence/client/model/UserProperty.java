...
public class UserProperty {
  ...
  public UserProperty key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public UserProperty value(@javax.annotation.Nonnull Map<String, Object> value) {
    this.value = value;
    return this;
  }
  ...
  public UserProperty id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public UserProperty lastModifiedDate(@javax.annotation.Nonnull OffsetDateTime lastModifiedDate) {
  ...
  public void setLastModifiedDate(@javax.annotation.Nonnull OffsetDateTime lastModifiedDate) {
    this.lastModifiedDate = lastModifiedDate;
  }


  public UserProperty createdDate(@javax.annotation.Nonnull OffsetDateTime createdDate) {
  ...
  public UserProperty links(@javax.annotation.Nullable Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "value", "id", "lastModifiedDate", "createdDate", "_links"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "value", "id", "lastModifiedDate", "createdDate"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UserProperty is not found in the empty JSON string", UserProperty.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserProperty.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserProperty` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
