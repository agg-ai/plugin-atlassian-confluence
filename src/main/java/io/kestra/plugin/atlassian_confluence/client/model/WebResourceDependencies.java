...
import io.kestra.plugin.atlassian_confluence.client.model.SuperBatchWebResources;
import io.kestra.plugin.atlassian_confluence.client.model.WebResourceDependenciesExpandable;
import io.kestra.plugin.atlassian_confluence.client.model.WebResourceDependenciesTags;
import io.kestra.plugin.atlassian_confluence.client.model.WebResourceDependenciesUris;
...
public class WebResourceDependencies {
  ...
  public WebResourceDependencies expandable(@javax.annotation.Nullable WebResourceDependenciesExpandable expandable) {
  ...
  public void setExpandable(@javax.annotation.Nullable WebResourceDependenciesExpandable expandable) {
    this.expandable = expandable;
  }


  public WebResourceDependencies keys(@javax.annotation.Nullable List<String> keys) {
    this.keys = keys;
    return this;
  }
  ...
  public WebResourceDependencies contexts(@javax.annotation.Nullable List<String> contexts) {
  ...
  public void setContexts(@javax.annotation.Nullable List<String> contexts) {
    this.contexts = contexts;
  }


  public WebResourceDependencies uris(@javax.annotation.Nullable WebResourceDependenciesUris uris) {
    this.uris = uris;
    return this;
  }
  ...
  public void setUris(@javax.annotation.Nullable WebResourceDependenciesUris uris) {
    this.uris = uris;
  }


  public WebResourceDependencies tags(@javax.annotation.Nullable WebResourceDependenciesTags tags) {
    this.tags = tags;
    return this;
  }
  ...
  public void setTags(@javax.annotation.Nullable WebResourceDependenciesTags tags) {
    this.tags = tags;
  }


  public WebResourceDependencies superbatch(@javax.annotation.Nullable SuperBatchWebResources superbatch) {
  ...
  public void setSuperbatch(@javax.annotation.Nullable SuperBatchWebResources superbatch) {
    this.superbatch = superbatch;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_expandable", "keys", "contexts", "uris", "tags", "superbatch"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebResourceDependencies.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WebResourceDependencies is not found in the empty JSON string", WebResourceDependencies.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebResourceDependencies.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebResourceDependencies` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
