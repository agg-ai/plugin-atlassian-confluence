...
public class CopyPageRequest {
  ...
  public CopyPageRequest copyAttachments(@javax.annotation.Nullable Boolean copyAttachments) {
  ...
  public CopyPageRequest copyPermissions(@javax.annotation.Nullable Boolean copyPermissions) {
  ...
  public CopyPageRequest copyProperties(@javax.annotation.Nullable Boolean copyProperties) {
  ...
  public CopyPageRequest copyLabels(@javax.annotation.Nullable Boolean copyLabels) {
  ...
  public CopyPageRequest copyCustomContents(@javax.annotation.Nullable Boolean copyCustomContents) {
  ...
  public CopyPageRequest destination(@javax.annotation.Nonnull CopyPageRequestDestination destination) {
  ...
  public void setDestination(@javax.annotation.Nonnull CopyPageRequestDestination destination) {
    this.destination = destination;
  }


  public CopyPageRequest pageTitle(@javax.annotation.Nullable String pageTitle) {
  ...
  public CopyPageRequest body(@javax.annotation.Nullable CopyPageRequestBody body) {
    this.body = body;
    return this;
  }
  ...
  public void setBody(@javax.annotation.Nullable CopyPageRequestBody body) {
    this.body = body;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("copyAttachments", "copyPermissions", "copyProperties", "copyLabels", "copyCustomContents", "destination", "pageTitle", "body"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopyPageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CopyPageRequest is not found in the empty JSON string", CopyPageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopyPageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CopyPageRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("pageTitle") != null && !jsonObj.get("pageTitle").isJsonNull()) && !jsonObj.get("pageTitle").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `pageTitle` to be a primitive type in the JSON string but got `%s`", jsonObj.get("pageTitle").toString()));
      }
