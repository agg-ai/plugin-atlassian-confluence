...
import io.kestra.plugin.atlassian_confluence.client.model.AddContentRestrictionRestrictions;
...
public class AddContentRestriction {
  ...
  public AddContentRestriction operation(@javax.annotation.Nonnull OperationEnum operation) {
  ...
  public AddContentRestriction restrictions(@javax.annotation.Nonnull AddContentRestrictionRestrictions restrictions) {
  ...
  public void setRestrictions(@javax.annotation.Nonnull AddContentRestrictionRestrictions restrictions) {
    this.restrictions = restrictions;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("operation", "restrictions"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddContentRestriction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddContentRestriction is not found in the empty JSON string", AddContentRestriction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddContentRestriction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddContentRestriction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
