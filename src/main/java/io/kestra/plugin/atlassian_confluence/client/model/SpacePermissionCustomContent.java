...
import io.kestra.plugin.atlassian_confluence.client.model.SpacePermissionCustomContentOperationsInner;
...
public class SpacePermissionCustomContent {
  ...
  public SpacePermissionCustomContent subject(@javax.annotation.Nonnull PermissionSubject subject) {
  ...
  public SpacePermissionCustomContent operations(@javax.annotation.Nonnull List<SpacePermissionCustomContentOperationsInner> operations) {
  ...
  public void setOperations(@javax.annotation.Nonnull List<SpacePermissionCustomContentOperationsInner> operations) {
    this.operations = operations;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("subject", "operations"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("subject", "operations"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SpacePermissionCustomContent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SpacePermissionCustomContent is not found in the empty JSON string", SpacePermissionCustomContent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SpacePermissionCustomContent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SpacePermissionCustomContent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
