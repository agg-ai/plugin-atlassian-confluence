...
import io.kestra.plugin.atlassian_confluence.client.model.LongTaskStatusWithLinksAdditionalDetails;
...
public class LongTaskStatusWithLinks {
  ...
  public LongTaskStatusWithLinks ari(@javax.annotation.Nullable String ari) {
    this.ari = ari;
    return this;
  }
  ...
  public LongTaskStatusWithLinks id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public LongTaskStatusWithLinks name(@javax.annotation.Nonnull LongTaskStatusName name) {
    this.name = name;
    return this;
  }
  ...
  public void setName(@javax.annotation.Nonnull LongTaskStatusName name) {
    this.name = name;
  }


  public LongTaskStatusWithLinks elapsedTime(@javax.annotation.Nonnull Long elapsedTime) {
  ...
  public void setElapsedTime(@javax.annotation.Nonnull Long elapsedTime) {
    this.elapsedTime = elapsedTime;
  }


  public LongTaskStatusWithLinks percentageComplete(@javax.annotation.Nonnull Integer percentageComplete) {
  ...
  public void setPercentageComplete(@javax.annotation.Nonnull Integer percentageComplete) {
    this.percentageComplete = percentageComplete;
  }


  public LongTaskStatusWithLinks successful(@javax.annotation.Nonnull Boolean successful) {
  ...
  public LongTaskStatusWithLinks finished(@javax.annotation.Nonnull Boolean finished) {
  ...
  public LongTaskStatusWithLinks messages(@javax.annotation.Nonnull List<Message> messages) {
  ...
  public LongTaskStatusWithLinks links(@javax.annotation.Nonnull Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  public LongTaskStatusWithLinks status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public LongTaskStatusWithLinks errors(@javax.annotation.Nullable List<Message> errors) {
    this.errors = errors;
    return this;
  }
  ...
  public LongTaskStatusWithLinks additionalDetails(@javax.annotation.Nullable LongTaskStatusWithLinksAdditionalDetails additionalDetails) {
  ...
  public void setAdditionalDetails(@javax.annotation.Nullable LongTaskStatusWithLinksAdditionalDetails additionalDetails) {
    this.additionalDetails = additionalDetails;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ari", "id", "name", "elapsedTime", "percentageComplete", "successful", "finished", "messages", "_links", "status", "errors", "additionalDetails"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "name", "elapsedTime", "percentageComplete", "successful", "finished", "messages", "_links"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LongTaskStatusWithLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in LongTaskStatusWithLinks is not found in the empty JSON string", LongTaskStatusWithLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LongTaskStatusWithLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `LongTaskStatusWithLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
