...
public class Relation {
  ...
  public Relation name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public Relation relationData(@javax.annotation.Nullable RelationData relationData) {
  ...
  public void setRelationData(@javax.annotation.Nullable RelationData relationData) {
    this.relationData = relationData;
  }


  public Relation source(@javax.annotation.Nullable RelationSource source) {
    this.source = source;
    return this;
  }
  ...
  public void setSource(@javax.annotation.Nullable RelationSource source) {
    this.source = source;
  }


  public Relation target(@javax.annotation.Nullable RelationSource target) {
    this.target = target;
    return this;
  }
  ...
  public void setTarget(@javax.annotation.Nullable RelationSource target) {
    this.target = target;
  }


  public Relation expandable(@javax.annotation.Nullable RelationExpandable expandable) {
  ...
  public void setExpandable(@javax.annotation.Nullable RelationExpandable expandable) {
    this.expandable = expandable;
  }


  public Relation links(@javax.annotation.Nonnull Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "relationData", "source", "target", "_expandable", "_links"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Relation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Relation is not found in the empty JSON string", Relation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Relation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Relation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
