...
public class RelationExpandable {
  ...
  public RelationExpandable relationData(@javax.annotation.Nullable String relationData) {
  ...
  public void setRelationData(@javax.annotation.Nullable String relationData) {
    this.relationData = relationData;
  }


  public RelationExpandable source(@javax.annotation.Nullable String source) {
    this.source = source;
    return this;
  }
  ...
  public RelationExpandable target(@javax.annotation.Nullable String target) {
    this.target = target;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("relationData", "source", "target"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RelationExpandable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in RelationExpandable is not found in the empty JSON string", RelationExpandable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RelationExpandable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RelationExpandable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("relationData") != null && !jsonObj.get("relationData").isJsonNull()) && !jsonObj.get("relationData").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `relationData` to be a primitive type in the JSON string but got `%s`", jsonObj.get("relationData").toString()));
      }
