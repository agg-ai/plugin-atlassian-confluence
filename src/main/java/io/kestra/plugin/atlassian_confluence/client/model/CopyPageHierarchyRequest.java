...
public class CopyPageHierarchyRequest {
  ...
  public CopyPageHierarchyRequest copyAttachments(@javax.annotation.Nullable Boolean copyAttachments) {
  ...
  public void setCopyAttachments(@javax.annotation.Nullable Boolean copyAttachments) {
    this.copyAttachments = copyAttachments;
  }


  public CopyPageHierarchyRequest copyPermissions(@javax.annotation.Nullable Boolean copyPermissions) {
  ...
  public void setCopyPermissions(@javax.annotation.Nullable Boolean copyPermissions) {
    this.copyPermissions = copyPermissions;
  }


  public CopyPageHierarchyRequest copyProperties(@javax.annotation.Nullable Boolean copyProperties) {
  ...
  public void setCopyProperties(@javax.annotation.Nullable Boolean copyProperties) {
    this.copyProperties = copyProperties;
  }


  public CopyPageHierarchyRequest copyLabels(@javax.annotation.Nullable Boolean copyLabels) {
  ...
  public void setCopyLabels(@javax.annotation.Nullable Boolean copyLabels) {
    this.copyLabels = copyLabels;
  }


  public CopyPageHierarchyRequest copyCustomContents(@javax.annotation.Nullable Boolean copyCustomContents) {
  ...
  public void setCopyCustomContents(@javax.annotation.Nullable Boolean copyCustomContents) {
    this.copyCustomContents = copyCustomContents;
  }


  public CopyPageHierarchyRequest copyDescendants(@javax.annotation.Nullable Boolean copyDescendants) {
  ...
  public void setCopyDescendants(@javax.annotation.Nullable Boolean copyDescendants) {
    this.copyDescendants = copyDescendants;
  }


  public CopyPageHierarchyRequest destinationPageId(@javax.annotation.Nonnull String destinationPageId) {
  ...
  public void setDestinationPageId(@javax.annotation.Nonnull String destinationPageId) {
    this.destinationPageId = destinationPageId;
  }


  public CopyPageHierarchyRequest titleOptions(@javax.annotation.Nullable CopyPageHierarchyTitleOptions titleOptions) {
  ...
  public void setTitleOptions(@javax.annotation.Nullable CopyPageHierarchyTitleOptions titleOptions) {
    this.titleOptions = titleOptions;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("copyAttachments", "copyPermissions", "copyProperties", "copyLabels", "copyCustomContents", "copyDescendants", "destinationPageId", "titleOptions"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("destinationPageId"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopyPageHierarchyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CopyPageHierarchyRequest is not found in the empty JSON string", CopyPageHierarchyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopyPageHierarchyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CopyPageHierarchyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("destinationPageId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `destinationPageId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("destinationPageId").toString()));
      }
