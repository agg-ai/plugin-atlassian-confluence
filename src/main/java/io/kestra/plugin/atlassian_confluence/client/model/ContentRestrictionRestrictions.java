...
import io.kestra.plugin.atlassian_confluence.client.model.GroupArray;
...
public class ContentRestrictionRestrictions {
  ...
  public ContentRestrictionRestrictions user(@javax.annotation.Nullable UserArray user) {
    this.user = user;
    return this;
  }
  ...
  public void setUser(@javax.annotation.Nullable UserArray user) {
    this.user = user;
  }


  public ContentRestrictionRestrictions group(@javax.annotation.Nullable GroupArray group) {
    this.group = group;
    return this;
  }
  ...
  public void setGroup(@javax.annotation.Nullable GroupArray group) {
    this.group = group;
  }


  public ContentRestrictionRestrictions expandable(@javax.annotation.Nullable ContentRestrictionRestrictionsExpandable expandable) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentRestrictionRestrictions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentRestrictionRestrictions is not found in the empty JSON string", ContentRestrictionRestrictions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentRestrictionRestrictions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentRestrictionRestrictions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
