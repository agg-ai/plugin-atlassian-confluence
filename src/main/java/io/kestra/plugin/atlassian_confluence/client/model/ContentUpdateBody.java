...
import io.kestra.plugin.atlassian_confluence.client.model.ContentBodyCreateStorage;
...
public class ContentUpdateBody {
  ...
  public ContentUpdateBody view(@javax.annotation.Nullable ContentBodyCreate view) {
    this.view = view;
    return this;
  }
  ...
  public ContentUpdateBody exportView(@javax.annotation.Nullable ContentBodyCreate exportView) {
  ...
  public ContentUpdateBody styledView(@javax.annotation.Nullable ContentBodyCreate styledView) {
  ...
  public ContentUpdateBody storage(@javax.annotation.Nullable ContentBodyCreateStorage storage) {
  ...
  public void setStorage(@javax.annotation.Nullable ContentBodyCreateStorage storage) {
    this.storage = storage;
  }


  public ContentUpdateBody editor(@javax.annotation.Nullable ContentBodyCreate editor) {
    this.editor = editor;
    return this;
  }
  ...
  public ContentUpdateBody editor2(@javax.annotation.Nullable ContentBodyCreate editor2) {
  ...
  public ContentUpdateBody wiki(@javax.annotation.Nullable ContentBodyCreate wiki) {
    this.wiki = wiki;
    return this;
  }
  ...
  public ContentUpdateBody atlasDocFormat(@javax.annotation.Nullable ContentBodyCreate atlasDocFormat) {
  ...
  public ContentUpdateBody anonymousExportView(@javax.annotation.Nullable ContentBodyCreate anonymousExportView) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentUpdateBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentUpdateBody is not found in the empty JSON string", ContentUpdateBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentUpdateBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentUpdateBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
