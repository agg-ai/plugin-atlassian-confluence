...
public class ContentStateResponse {
  ...
  public ContentStateResponse contentState(@javax.annotation.Nullable ContentState contentState) {
  ...
  public void setContentState(@javax.annotation.Nullable ContentState contentState) {
    this.contentState = contentState;
  }


  public ContentStateResponse lastUpdated(@javax.annotation.Nullable String lastUpdated) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("contentState", "lastUpdated"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentStateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentStateResponse is not found in the empty JSON string", ContentStateResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentStateResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentStateResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
