...
import io.kestra.plugin.atlassian_confluence.client.model.ContentRestrictionUpdate;
...
public class ContentRestrictionAddOrUpdateArrayOneOf {
  ...
  public ContentRestrictionAddOrUpdateArrayOneOf results(@javax.annotation.Nonnull List<ContentRestrictionUpdate> results) {
  ...
  public void setResults(@javax.annotation.Nonnull List<ContentRestrictionUpdate> results) {
    this.results = results;
  }


  public ContentRestrictionAddOrUpdateArrayOneOf start(@javax.annotation.Nullable Integer start) {
    this.start = start;
    return this;
  }
  ...
  public ContentRestrictionAddOrUpdateArrayOneOf limit(@javax.annotation.Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ContentRestrictionAddOrUpdateArrayOneOf size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public ContentRestrictionAddOrUpdateArrayOneOf restrictionsHash(@javax.annotation.Nullable String restrictionsHash) {
  ...
  public void setRestrictionsHash(@javax.annotation.Nullable String restrictionsHash) {
    this.restrictionsHash = restrictionsHash;
  }


  public ContentRestrictionAddOrUpdateArrayOneOf links(@javax.annotation.Nullable Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("results", "start", "limit", "size", "restrictionsHash", "_links"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentRestrictionAddOrUpdateArrayOneOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContentRestrictionAddOrUpdateArrayOneOf is not found in the empty JSON string", ContentRestrictionAddOrUpdateArrayOneOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentRestrictionAddOrUpdateArrayOneOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContentRestrictionAddOrUpdateArrayOneOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("restrictionsHash") != null && !jsonObj.get("restrictionsHash").isJsonNull()) && !jsonObj.get("restrictionsHash").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `restrictionsHash` to be a primitive type in the JSON string but got `%s`", jsonObj.get("restrictionsHash").toString()));
      }
  }
